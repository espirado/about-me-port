...
var J = E((ff, ei) => {
  ...
  ei.exports = wt(typeof globalThis == "object" && globalThis) || wt(typeof window == "object" && window) || wt(typeof self == "object" && self) || wt(typeof global == "object" && global) || function() {
    return this;
...
var kt = E((xf, ii) => {
  var eh = It(), Nt = Function.prototype.call;
  ii.exports = eh ? Nt.bind(Nt) : function() {
    return Nt.apply(Nt, arguments);
  };
});
var li = E((oi) => {
  "use strict";
  var ai = {}.propertyIsEnumerable, ni = Object.getOwnPropertyDescriptor, th = ni && !ai.call({ 1: 2 }, 1);
  oi.f = th ? function(c) {
    var f = ni(this, c);
...
var ys = E((Pf, hi) => {
  hi.exports = function(l, c) {
    return { enumerable: !(l & 1), configurable: !(l & 2), writable: !(l & 4), value: c };
  };
});
var ce = E((Af, pi) => {
  var ui = It(), ci = Function.prototype, sh = ci.bind, xs = ci.call, rh = ui && sh.bind(xs, xs);
  pi.exports = ui ? function(l) {
    return l && rh(l);
  } : function(l) {
    return l && function() {
      return xs.apply(l, arguments);
    };
  };
});
var Dt = E((Tf, di) => {
  var fi = ce(), ih = fi({}.toString), ah = fi("".slice);
  di.exports = function(l) {
    return ah(ih(l), 8, -1);
  };
});
var yi = E((vf, mi) => {
  var nh = J(), oh = ce(), lh = ve(), hh = Dt(), gs = nh.Object, uh = oh("".split);
  mi.exports = lh(function() {
    return !gs("z").propertyIsEnumerable(0);
  }) ? function(l) {
    return hh(l) == "String" ? uh(l, "") : gs(l);
  } : gs;
});
var Ps = E((Ef, xi) => {
  var ch = J(), ph = ch.TypeError;
  xi.exports = function(l) {
    if (l == null)
      throw ph("Can't call method on " + l);
    return l;
  };
});
var Ft = E((bf, gi) => {
...
var Re = E((Sf, Ai) => {
  ...
  Ai.exports = function(l) {
    return typeof l == "object" ? l !== null : mh(l);
  };
});
var nt = E((wf, Ti) => {
  var As = J(), yh = pe(), xh = function(l) {
    return yh(l) ? l : void 0;
  };
  Ti.exports = function(l, c) {
    return arguments.length < 2 ? xh(As[l]) : As[l] && As[l][c];
  };
});
var Ei = E((If, vi) => {
  var gh = ce();
  vi.exports = gh({}.isPrototypeOf);
});
var Ci = E((Nf, bi) => {
  var Ph = nt();
  bi.exports = Ph("navigator", "userAgent") || "";
});
var Fi = E((kf, Di) => {
  var ki = J(), Ts = Ci(), Si = ki.process, wi = ki.Deno, Ii = Si && Si.versions || wi && wi.version, Ni = Ii && Ii.v8, de, Lt;
  Ni && (de = Ni.split("."), Lt = de[0] > 0 && de[0] < 4 ? 1 : +(de[0] + de[1]));
  !Lt && Ts && (de = Ts.match(/Edge\/(\d+)/), (!de || de[1] >= 74) && (de = Ts.match(/Chrome\/(\d+)/), de && (Lt = +de[1])));
  Di.exports = Lt;
});
var vs = E((Df, Oi) => {
  var Li = Fi(), Ah = ve();
  Oi.exports = !!Object.getOwnPropertySymbols && !Ah(function() {
    var l = Symbol();
    return !String(l) || !(Object(l) instanceof Symbol) || !Symbol.sham && Li && Li < 41;
  });
});
var Es = E((Ff, Mi) => {
  var Th = vs();
  Mi.exports = Th && !Symbol.sham && typeof Symbol.iterator == "symbol";
});
var bs = E((Lf, Bi) => {
  var vh = J(), Eh = nt(), bh = pe(), Ch = Ei(), Sh = Es(), wh = vh.Object;
  Bi.exports = Sh ? function(l) {
    return typeof l == "symbol";
  } : function(l) {
    var c = Eh("Symbol");
    return bh(c) && Ch(c.prototype, wh(l));
  };
});
var Ri = E((Of, _i) => {
  var Ih = J(), Nh = Ih.String;
  _i.exports = function(l) {
    try {
      return Nh(l);
    } catch {
      return "Object";
...
var Ot = E((Mf, ji) => {
  var kh = J(), Dh = pe(), Fh = Ri(), Lh = kh.TypeError;
  ji.exports = function(l) {
    if (Dh(l))
      return l;
    throw Lh(Fh(l) + " is not a function");
  };
});
var Ui = E((Bf, qi) => {
  var Oh = Ot();
  qi.exports = function(l, c) {
    var f = l[c];
    return f == null ? void 0 : Oh(f);
  };
});
var $i = E((_f, Hi) => {
  var Mh = J(), Cs = kt(), Ss = pe(), ws = Re(), Bh = Mh.TypeError;
  Hi.exports = function(l, c) {
    var f, d;
    if (c === "string" && Ss(f = l.toString) && !ws(d = Cs(f, l)) || Ss(f = l.valueOf) && !ws(d = Cs(f, l)) || c !== "string" && Ss(f = l.toString) && !ws(d = Cs(f, l)))
      return d;
...
var Mt = E((jf, Wi) => {
  var Ki = J(), _h = Object.defineProperty;
  Wi.exports = function(l, c) {
    try {
      _h(Ki, l, { value: c, configurable: true, writable: true });
    } catch {
      Ki[l] = c;
    }
    return c;
...
var Bt = E((qf, Ji) => {
  var Rh = J(), jh = Mt(), Gi = "__core-js_shared__", qh = Rh[Gi] || jh(Gi, {});
  Ji.exports = qh;
});
var Is = E((Uf, Yi) => {
  var Uh = Vi(), Xi = Bt();
  (Yi.exports = function(l, c) {
    return Xi[l] || (Xi[l] = c !== void 0 ? c : {});
  })("versions", []).push({ version: "3.22.2", mode: Uh ? "pure" : "global", copyright: "© 2014-2022 Denis Pushkarev (zloirock.ru)", license: "https://github.com/zloirock/core-js/blob/v3.22.2/LICENSE", source: "https://github.com/zloirock/core-js" });
});
var Ns = E((Hf, Qi) => {
  var Hh = J(), $h = Ps(), zh = Hh.Object;
  Qi.exports = function(l) {
    return zh($h(l));
  };
});
var Ne = E(($f, Zi) => {
  var Vh = ce(), Kh = Ns(), Wh = Vh({}.hasOwnProperty);
  Zi.exports = Object.hasOwn || function(c, f) {
    return Wh(Kh(c), f);
  };
});
var ks = E((zf, ea) => {
  var Gh = ce(), Jh = 0, Xh = Math.random(), Yh = Gh(1 .toString);
  ea.exports = function(l) {
    return "Symbol(" + (l === void 0 ? "" : l) + ")_" + Yh(++Jh + Xh, 36);
  };
});
var ot = E((Vf, aa) => {
  var Qh = J(), Zh = Is(), ta = Ne(), eu = ks(), sa = vs(), ia = Es(), Xe = Zh("wks"), je = Qh.Symbol, ra = je && je.for, tu = ia ? je : je && je.withoutSetter || eu;
  aa.exports = function(l) {
    if (!ta(Xe, l) || !(sa || typeof Xe[l] == "string")) {
      var c = "Symbol." + l;
      sa && ta(je, l) ? Xe[l] = je[l] : ia && ra ? Xe[l] = ra(c) : Xe[l] = tu(c);
    }
    return Xe[l];
  };
});
var ha = E((Kf, la) => {
  var su = J(), ru = kt(), na = Re(), oa = bs(), iu = Ui(), au = $i(), nu = ot(), ou = su.TypeError, lu = nu("toPrimitive");
  la.exports = function(l, c) {
    if (!na(l) || oa(l))
      return l;
    var f = iu(l, lu), d;
    if (f) {
      if (c === void 0 && (c = "default"), d = ru(f, l, c), !na(d) || oa(d))
        return d;
      throw ou("Can't convert object to primitive value");
    }
    return c === void 0 && (c = "number"), au(l, c);
  };
});
var Ds = E((Wf, ua) => {
  var hu = ha(), uu = bs();
...
var fa = E((Gf, pa) => {
  var cu = J(), ca = Re(), Fs = cu.document, pu = ca(Fs) && ca(Fs.createElement);
  pa.exports = function(l) {
    return pu ? Fs.createElement(l) : {};
  };
});
var Ls = E((Jf, da) => {
  var fu = _e(), du = ve(), mu = fa();
  da.exports = !fu && !du(function() {
...
var Os = E((ya) => {
  var yu = _e(), xu = kt(), gu = li(), Pu = ys(), Au = Ft(), Tu = Ds(), vu = Ne(), Eu = Ls(), ma = Object.getOwnPropertyDescriptor;
  ya.f = yu ? ma : function(c, f) {
    if (c = Au(c), f = Tu(f), Eu)
      try {
        return ma(c, f);
      } catch {
    ...
    if (vu(c, f))
      return Pu(!xu(gu.f, c, f), c[f]);
  };
});
var ga = E((Yf, xa) => {
  var bu = _e(), Cu = ve();
  xa.exports = bu && Cu(function() {
    return Object.defineProperty(function() {
    }, "prototype", { value: 42, writable: false }).prototype != 42;
  });
});
var Ms = E((Qf, Aa) => {
  var Pa = J(), Su = Re(), wu = Pa.String, Iu = Pa.TypeError;
  Aa.exports = function(l) {
    if (Su(l))
      return l;
    throw Iu(wu(l) + " is not an object");
  };
});
var qs = E((va) => {
  var Nu = J(), ku = _e(), Du = Ls(), Fu = ga(), _t = Ms(), Ta = Ds(), Lu = Nu.TypeError, Bs = Object.defineProperty, Ou = Object.getOwnPropertyDescriptor, _s = "enumerable", Rs = "configurable", js = "writable";
  va.f = ku ? Fu ? function(c, f, d) {
    if (_t(c), f = Ta(f), _t(d), typeof c == "function" && f === "prototype" && "value" in d && js in d && !d[js]) {
      var x = Ou(c, f);
      x && x[js] && (c[f] = d.value, d = { configurable: Rs in d ? d[Rs] : x[Rs], enumerable: _s in d ? d[_s] : x[_s], writable: false });
    }
    return Bs(c, f, d);
  } : Bs : function(c, f, d) {
    if (_t(c), f = Ta(f), _t(d), Du)
      try {
        return Bs(c, f, d);
      } catch {
      }
    if ("get" in d || "set" in d)
      throw Lu("Accessors not supported");
    return "value" in d && (c[f] = d.value), c;
  };
});
var Rt = E((ed, Ea) => {
  var Mu = _e(), Bu = qs(), _u = ys();
  Ea.exports = Mu ? function(l, c, f) {
    return Bu.f(l, c, _u(1, f));
  } : function(l, c, f) {
    return l[c] = f, l;
  };
});
var jt = E((td, ba) => {
  var Ru = ce(), ju = pe(), Us = Bt(), qu = Ru(Function.toString);
  ju(Us.inspectSource) || (Us.inspectSource = function(l) {
    return qu(l);
  });
  ba.exports = Us.inspectSource;
});
var wa = E((sd, Sa) => {
  var Uu = J(), Hu = pe(), $u = jt(), Ca = Uu.WeakMap;
  Sa.exports = Hu(Ca) && /native code/.test($u(Ca));
});
var ka = E((rd, Na) => {
  var zu = Is(), Vu = ks(), Ia = zu("keys");
  Na.exports = function(l) {
    return Ia[l] || (Ia[l] = Vu(l));
  };
});
var Hs = E((id, Da) => {
  Da.exports = {};
...
var _a = E((ad, Ba) => {
  var Ku = wa(), Ma = J(), $s = ce(), Wu = Re(), Gu = Rt(), zs = Ne(), Vs = Bt(), Ju = ka(), Xu = Hs(), Fa = "Object already initialized", Ws = Ma.TypeError, Yu = Ma.WeakMap, qt, lt, Ut, Qu = function(l) {
    return Ut(l) ? lt(l) : qt(l, {});
  }, Zu = function(l) {
    return function(c) {
      var f;
      if (!Wu(c) || (f = lt(c)).type !== l)
        throw Ws("Incompatible receiver, " + l + " required");
      return f;
    };
  };
  Ku || Vs.state ? (ke = Vs.state || (Vs.state = new Yu()), La = $s(ke.get), Ks = $s(ke.has), Oa = $s(ke.set), qt = function(l, c) {
    if (Ks(ke, l))
      throw new Ws(Fa);
    return c.facade = l, Oa(ke, l, c), c;
  }, lt = function(l) {
    return La(ke, l) || {};
  }, Ut = function(l) {
    return Ks(ke, l);
  }) : (qe = Ju("state"), Xu[qe] = true, qt = function(l, c) {
    if (zs(l, qe))
      throw new Ws(Fa);
    return c.facade = l, Gu(l, qe, c), c;
  }, lt = function(l) {
    return zs(l, qe) ? l[qe] : {};
  }, Ut = function(l) {
    return zs(l, qe);
  ...
  var ke, La, Ks, Oa, qe;
  Ba.exports = { set: qt, get: lt, has: Ut, enforce: Qu, getterFor: Zu };
});
var qa = E((nd, ja) => {
  var Gs = _e(), ec = Ne(), Ra = Function.prototype, tc = Gs && Object.getOwnPropertyDescriptor, Js = ec(Ra, "name"), sc = Js && function() {
  }.name === "something", rc = Js && (!Gs || Gs && tc(Ra, "name").configurable);
  ja.exports = { EXISTS: Js, PROPER: sc, CONFIGURABLE: rc };
});
var Va = E((od, za) => {
  var ic = J(), Ua = pe(), ac = Ne(), Ha = Rt(), nc = Mt(), oc = jt(), $a = _a(), lc = qa().CONFIGURABLE, hc = $a.get, uc = $a.enforce, cc = String(String).split("String");
  (za.exports = function(l, c, f, d) {
    var x = d ? !!d.unsafe : false, g = d ? !!d.enumerable : false, A = d ? !!d.noTargetGet : false, T = d && d.name !== void 0 ? d.name : c, S;
    if (Ua(f) && (String(T).slice(0, 7) === "Symbol(" && (T = "[" + String(T).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), (!ac(f, "name") || lc && f.name !== T) && Ha(f, "name", T), S = uc(f), S.source || (S.source = cc.join(typeof T == "string" ? T : ""))), l === ic) {
      g ? l[c] = f : nc(c, f);
      return;
    } else
      x ? !A && l[c] && (g = true) : delete l[c];
    g ? l[c] = f : Ha(l, c, f);
  })(Function.prototype, "toString", function() {
    return Ua(this) && hc(this).source || oc(this);
  });
});
var Xs = E((ld, Ka) => {
  var pc = Math.ceil, fc = Math.floor;
  Ka.exports = function(l) {
    var c = +l;
    return c !== c || c === 0 ? 0 : (c > 0 ? fc : pc)(c);
  };
});
var Ga = E((hd, Wa) => {
  var dc = Xs(), mc = Math.max, yc = Math.min;
  Wa.exports = function(l, c) {
    var f = dc(l);
    return f < 0 ? mc(f + c, 0) : yc(f, c);
  };
});
var Xa = E((ud, Ja) => {
  var xc = Xs(), gc = Math.min;
  Ja.exports = function(l) {
    return l > 0 ? gc(xc(l), 9007199254740991) : 0;
  };
});
var Ht = E((cd, Ya) => {
  var Pc = Xa();
...
var en = E((pd, Za) => {
  var Ac = Ft(), Tc = Ga(), vc = Ht(), Qa = function(l) {
    return function(c, f, d) {
      var x = Ac(c), g = vc(x), A = Tc(d, g), T;
      if (l && f != f) {
        for (; g > A; )
          if (T = x[A++], T != T)
            return true;
  ...
  Za.exports = { includes: Qa(true), indexOf: Qa(false) };
});
var rn = E((fd, sn) => {
  var Ec = ce(), Ys = Ne(), bc = Ft(), Cc = en().indexOf, Sc = Hs(), tn = Ec([].push);
  sn.exports = function(l, c) {
    var f = bc(l), d = 0, x = [], g;
    for (g in f)
      !Ys(Sc, g) && Ys(f, g) && tn(x, g);
    for (; c.length > d; )
      Ys(f, g = c[d++]) && (~Cc(x, g) || tn(x, g));
    return x;
  };
});
var nn = E((dd, an) => {
  an.exports = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"];
});
var ln = E((on) => {
  var wc = rn(), Ic = nn(), Nc = Ic.concat("length", "prototype");
  on.f = Object.getOwnPropertyNames || function(c) {
    return wc(c, Nc);
  };
});
var un = E((hn) => {
...
var pn = E((xd, cn) => {
  var kc = nt(), Dc = ce(), Fc = ln(), Lc = un(), Oc = Ms(), Mc = Dc([].concat);
  cn.exports = kc("Reflect", "ownKeys") || function(c) {
    var f = Fc.f(Oc(c)), d = Lc.f;
    return d ? Mc(f, d(c)) : f;
  };
});
var mn = E((gd, dn) => {
  var fn = Ne(), Bc = pn(), _c = Os(), Rc = qs();
  dn.exports = function(l, c, f) {
    for (var d = Bc(c), x = Rc.f, g = _c.f, A = 0; A < d.length; A++) {
      var T = d[A];
      !fn(l, T) && !(f && fn(f, T)) && x(l, T, g(c, T));
    }
  };
});
var xn = E((Pd, yn) => {
  var jc = ve(), qc = pe(), Uc = /#|\.prototype\./, ht = function(l, c) {
    var f = $c[Hc(l)];
    return f == Vc ? true : f == zc ? false : qc(c) ? jc(c) : !!c;
  }, Hc = ht.normalize = function(l) {
    return String(l).replace(Uc, ".").toLowerCase();
  }, $c = ht.data = {}, zc = ht.NATIVE = "N", Vc = ht.POLYFILL = "P";
  yn.exports = ht;
});
var Zs = E((Ad, gn) => {
  var Qs = J(), Kc = Os().f, Wc = Rt(), Gc = Va(), Jc = Mt(), Xc = mn(), Yc = xn();
  gn.exports = function(l, c) {
    var f = l.target, d = l.global, x = l.stat, g, A, T, S, O, I;
    if (d ? A = Qs : x ? A = Qs[f] || Jc(f, {}) : A = (Qs[f] || {}).prototype, A)
      for (T in c) {
        if (O = c[T], l.noTargetGet ? (I = Kc(A, T), S = I && I.value) : S = A[T], g = Yc(d ? T : f + (x ? "." : "#") + T, l.forced), !g && S !== void 0) {
          if (typeof O == typeof S)
            continue;
          Xc(O, S);
        }
        (l.sham || S && S.sham) && Wc(O, "sham", true), Gc(A, T, O, l);
      }
  };
});
var Pn = E(() => {
  var Qc = Zs(), Zc = J();
  Qc({ global: true }, { globalThis: Zc });
});
var er = E((Ed, An) => {
  var ep = Dt();
  An.exports = Array.isArray || function(c) {
    return ep(c) == "Array";
  };
});
var En = E((bd, vn) => {
  var Tn = ce(), tp = Ot(), sp = It(), rp = Tn(Tn.bind);
  vn.exports = function(l, c) {
    return tp(l), c === void 0 ? l : sp ? rp(l, c) : function() {
...
var Sn = E((Cd, Cn) => {
  "use strict";
  var ip = J(), ap = er(), np = Ht(), op = En(), lp = ip.TypeError, bn = function(l, c, f, d, x, g, A, T) {
    for (var S = x, O = 0, I = A ? op(A, T) : false, C, L; O < d; ) {
      if (O in f) {
        if (C = I ? I(f[O], O, c) : f[O], g > 0 && ap(C))
          L = np(C), S = bn(l, c, C, L, S, g - 1) - 1;
        else {
          if (S >= 9007199254740991)
            throw lp("Exceed the acceptable array length");
          l[S] = C;
        }
        S++;
      }
...
var Nn = E((Sd, In) => {
  var hp = ot(), up = hp("toStringTag"), wn = {};
  wn[up] = "z";
  In.exports = String(wn) === "[object z]";
});
var Dn = E((wd, kn) => {
  var cp = J(), pp = Nn(), fp = pe(), $t = Dt(), dp = ot(), mp = dp("toStringTag"), yp = cp.Object, xp = $t(function() {
    return arguments;
  }()) == "Arguments", gp = function(l, c) {
    try {
      return l[c];
    } catch {
    }
  };
  kn.exports = pp ? $t : function(l) {
    var c, f, d;
    return l === void 0 ? "Undefined" : l === null ? "Null" : typeof (f = gp(c = yp(l), mp)) == "string" ? f : xp ? $t(c) : (d = $t(c)) == "Object" && fp(c.callee) ? "Arguments" : d;
  };
});
var _n = E((Id, Bn) => {
  var Pp = ce(), Ap = ve(), Fn = pe(), Tp = Dn(), vp = nt(), Ep = jt(), Ln = function() {
  }, bp = [], On = vp("Reflect", "construct"), tr = /^\s*(?:class|function)\b/, Cp = Pp(tr.exec), Sp = !tr.exec(Ln), ut = function(c) {
    if (!Fn(c))
      return false;
    try {
      return On(Ln, bp, c), true;
    } catch {
      return false;
    }
  }, Mn = function(c) {
    ...
    try {
      return Sp || !!Cp(tr, Ep(c));
    } catch {
      return true;
    }
  };
  Mn.sham = true;
  Bn.exports = !On || Ap(function() {
    var l;
...
var Un = E((Nd, qn) => {
  var wp = J(), Rn = er(), Ip = _n(), Np = Re(), kp = ot(), Dp = kp("species"), jn = wp.Array;
  qn.exports = function(l) {
    var c;
    return Rn(l) && (c = l.constructor, Ip(c) && (c === jn || Rn(c.prototype)) ? c = void 0 : Np(c) && (c = c[Dp], c === null && (c = void 0))), c === void 0 ? jn : c;
  };
});
var $n = E((kd, Hn) => {
  var Fp = Un();
  Hn.exports = function(l, c) {
    return new (Fp(l))(c === 0 ? 0 : c);
  };
});
Pn();
var Lp = Zs();
...
var _p = Ht();
var Rp = $n();
Lp({ target: "Array", proto: true }, { flatMap: function(c) {
  var f = Bp(this), d = _p(f), x;
  return Mp(c), x = Rp(f, 0), x.length = Op(x, f, f, d, 0, 1, c, arguments.length > 1 ? arguments[1] : void 0), x;
} });
var ar = Object.defineProperty;
var jp = Object.getOwnPropertyDescriptor;
var nr = Object.getOwnPropertyNames;
var qp = Object.prototype.hasOwnProperty;
var zn = (l, c) => function() {
  return l && (c = (0, l[nr(l)[0]])(l = 0)), c;
};
var W = (l, c) => function() {
  return c || (0, l[nr(l)[0]])((c = { exports: {} }).exports, c), c.exports;
};
var Up = (l, c) => {
  for (var f in c)
    ar(l, f, { get: c[f], enumerable: true });
};
var Hp = (l, c, f, d) => {
  if (c && typeof c == "object" || typeof c == "function")
    for (let x of nr(c))
      !qp.call(l, x) && x !== f && ar(l, x, { get: () => c[x], enumerable: !(d = jp(c, x)) || d.enumerable });
  return l;
};
var $p = (l) => Hp(ar({}, "__esModule", { value: true }), l);
var K = zn({ "<define:process>"() {
} });
var zp = W({ "src/utils/try-combinations.js"(l, c) {
  "use strict";
  K();
  function f() {
    let d;
    for (var x = arguments.length, g = new Array(x), A = 0; A < x; A++)
      g[A] = arguments[A];
    for (let [T, S] of g.entries())
      try {
        return { result: S() };
      } catch (O) {
        T === 0 && (d = O);
...
var Vn = W({ "src/language-js/utils/get-shebang.js"(l, c) {
  "use strict";
  K();
  function f(d) {
    if (!d.startsWith("#!"))
...
var Vp = W({ "src/utils/text/skip-inline-comment.js"(l, c) {
  "use strict";
  K();
  function f(d, x) {
    if (x === false)
...
var Kp = W({ "src/utils/text/skip-newline.js"(l, c) {
  "use strict";
  K();
  function f(d, x, g) {
    let A = g && g.backwards;
...
var Kn = W({ "src/utils/text/skip.js"(l, c) {
  "use strict";
  K();
  function f(T) {
    return (S, O, I) => {
  ...
  var d = f(/\s/), x = f(" 	"), g = f(",; 	"), A = f(/[^\n\r]/);
  c.exports = { skipWhitespace: d, skipSpaces: x, skipToLineEnd: g, skipEverythingButNewLine: A };
} });
var Wp = W({ "src/utils/text/skip-trailing-comment.js"(l, c) {
  "use strict";
  K();
  var { skipEverythingButNewLine: f } = Kn();
  function d(x, g) {
    return g === false ? false : x.charAt(g) === "/" && x.charAt(g + 1) === "/" ? f(x, g) : g;
  }
  c.exports = d;
} });
var Gp = W({ "src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(l, c) {
  "use strict";
  K();
  var f = Vp(), d = Kp(), x = Wp(), { skipSpaces: g } = Kn();
  function A(T, S) {
    let O = null, I = S;
    for (; I !== O; )
      O = I, I = g(T, I), I = f(T, I), I = x(T, I), I = d(T, I);
    return I;
  }
  c.exports = A;
} });
var Wn = {};
Up(Wn, { EOL: () => ir, arch: () => Jp, cpus: () => eo, default: () => ao, endianness: () => Gn, freemem: () => Qn, getNetworkInterfaces: () => io, hostname: () => Jn, loadavg: () => Xn, networkInterfaces: () => ro, platform: () => Xp, release: () => so, tmpDir: () => sr, tmpdir: () => rr, totalmem: () => Zn, type: () => to, uptime: () => Yn });
function Gn() {
  if (typeof zt > "u") {
    var l = new ArrayBuffer(2), c = new Uint8Array(l), f = new Uint16Array(l);
    if (c[0] = 1, c[1] = 2, f[0] === 258)
      zt = "BE";
    else if (f[0] === 513)
      zt = "LE";
    else
...
var ir;
var ao;
var Yp = zn({ "node-modules-polyfills:os"() {
  K(), rr = sr, ir = `
`, ao = { EOL: ir, tmpdir: rr, tmpDir: sr, networkInterfaces: ro, getNetworkInterfaces: io, release: so, type: to, cpus: eo, totalmem: Zn, freemem: Qn, uptime: Yn, loadavg: Xn, hostname: Jn, endianness: Gn };
} });
var Qp = W({ "node-modules-polyfills-commonjs:os"(l, c) {
  K();
  var f = (Yp(), $p(Wn));
  if (f && f.default) {
    c.exports = f.default;
...
var Zp = W({ "node_modules/detect-newline/index.js"(l, c) {
  "use strict";
  K();
  var f = (d) => {
    if (typeof d != "string")
...
var ef = W({ "node_modules/jest-docblock/build/index.js"(l) {
  "use strict";
  K(), Object.defineProperty(l, "__esModule", { value: true }), l.extract = R, l.parse = $, l.parseWithComments = X, l.print = D, l.strip = N;
  function c() {
    let h = Qp();
    return c = function() {
      return h;
  ...
  function N(h) {
    let Y = h.match(A);
    return Y && Y[0] ? h.substring(Y[0].length) : h;
  }
  function $(h) {
    return X(h).pragmas;
  }
  function X(h) {
    let Y = (0, f().default)(h) || c().EOL;
    h = h.replace(g, "").replace(x, "").replace(C, "$1");
    let oe = "";
    for (; oe !== h; )
      oe = h, h = h.replace(O, `${Y}$1 $2${Y}`);
    h = h.replace(S, "").trimRight();
    let Z = /* @__PURE__ */ Object.create(null), Ee = h.replace(I, "").replace(S, "").trimRight(), te;
    for (; te = I.exec(h); ) {
      let U = te[2].replace(T, "");
      typeof Z[te[1]] == "string" || Array.isArray(Z[te[1]]) ? Z[te[1]] = L.concat(Z[te[1]], U) : Z[te[1]] = U;
    }
    return { comments: Ee, pragmas: Z };
  }
  function D(h) {
    let { comments: Y = "", pragmas: oe = {} } = h, Z = (0, f().default)(Y) || c().EOL, Ee = "/**", te = " *", U = " */", M = Object.keys(oe), v = M.map((V) => _(V, oe[V])).reduce((V, Q) => V.concat(Q), []).map((V) => `${te} ${V}${Z}`).join("");
    if (!Y) {
      if (M.length === 0)
        return "";
      if (M.length === 1 && !Array.isArray(oe[M[0]])) {
        let V = oe[M[0]];
        return `${Ee} ${_(M[0], V)[0]}${U}`;
      }
    }
    let De = Y.split(Z).map((V) => `${te} ${V}`).join(Z) + Z;
    return Ee + Z + (Y ? De : "") + (Y && M.length ? te + Z : "") + v + U;
  }
  function _(h, Y) {
    return L.concat(Y).map((oe) => `@${h} ${oe}`.trim());
  }
} });
var tf = W({ "src/common/end-of-line.js"(l, c) {
  "use strict";
  K();
  function f(A) {
    let T = A.indexOf("\r");
    return T >= 0 ? A.charAt(T + 1) === `
` ? "crlf" : "cr" : "lf";
  }
  function d(A) {
    switch (A) {
...
`);
  ...
  c.exports = { guessEndOfLine: f, convertEndOfLineToChars: d, countEndOfLineChars: x, normalizeEndOfLine: g };
} });
var sf = W({ "src/language-js/pragma.js"(l, c) {
  "use strict";
  K();
  var { parseWithComments: f, strip: d, extract: x, print: g } = ef(), { normalizeEndOfLine: A } = tf(), T = Vn();
  function S(C) {
    let L = T(C);
    L && (C = C.slice(L.length + 1));
    let R = x(C), { pragmas: N, comments: $ } = f(R);
    return { shebang: L, text: C, pragmas: N, comments: $ };
  }
  function O(C) {
  ...
  function I(C) {
    let { shebang: L, text: R, pragmas: N, comments: $ } = S(C), X = d(R), D = g({ pragmas: Object.assign({ format: "" }, N), comments: $.trimStart() });
    return (L ? `${L}
` : "") + A(D) + (X.startsWith(`
`) ? `
` : `
...
`) + X;
  ...
  c.exports = { hasPragma: O, insertPragma: I };
} });
var or = W({ "src/utils/is-non-empty-array.js"(l, c) {
  "use strict";
  K();
  function f(d) {
...
var no = W({ "src/language-js/loc.js"(l, c) {
  "use strict";
  K();
  var f = or();
  function d(S) {
    var O, I;
    let C = S.range ? S.range[0] : S.start, L = (O = (I = S.declaration) === null || I === void 0 ? void 0 : I.decorators) !== null && O !== void 0 ? O : S.decorators;
  ...
  function g(S, O) {
    let I = d(S);
    return Number.isInteger(I) && I === d(O);
  }
  function A(S, O) {
    let I = x(S);
    return Number.isInteger(I) && I === x(O);
  }
  function T(S, O) {
    return g(S, O) && A(S, O);
  }
  c.exports = { locStart: d, locEnd: x, hasSameLocStart: g, hasSameLoc: T };
} });
var oo = W({ "src/language-js/parse/utils/create-parser.js"(l, c) {
  "use strict";
  K();
  var { hasPragma: f } = sf(), { locStart: d, locEnd: x } = no();
  function g(A) {
    return A = typeof A == "function" ? { parse: A } : A, Object.assign({ astFormat: "estree", hasPragma: f, locStart: d, locEnd: x }, A);
  }
  c.exports = g;
} });
var lr = W({ "src/common/parser-create-error.js"(l, c) {
  "use strict";
  K();
  function f(d, x) {
    let g = new SyntaxError(d + " (" + x.start.line + ":" + x.start.column + ")");
    return g.loc = x, g;
  }
  c.exports = f;
} });
var lo = W({ "src/language-js/parse/utils/create-babel-parse-error.js"(l, c) {
  "use strict";
  K();
  var f = lr();
  function d(x) {
    let { message: g, loc: A } = x;
    return f(g.replace(/ \(.*\)/, ""), { start: { line: A ? A.line : 0, column: A ? A.column + 1 : 0 } });
  }
  c.exports = d;
} });
var rf = W({ "src/language-js/utils/is-ts-keyword-type.js"(l, c) {
  "use strict";
  K();
  function f(d) {
    let { type: x } = d;
...
var af = W({ "src/language-js/utils/is-block-comment.js"(l, c) {
  "use strict";
  K();
  var f = /* @__PURE__ */ new Set(["Block", "CommentBlock", "MultiLine"]), d = (x) => f.has(x == null ? void 0 : x.type);
  c.exports = d;
} });
var nf = W({ "src/language-js/utils/is-type-cast-comment.js"(l, c) {
  "use strict";
  K();
  var f = af();
  function d(x) {
    return f(x) && x.value[0] === "*" && /@type\b/.test(x.value);
  }
  c.exports = d;
} });
var of = W({ "src/utils/get-last.js"(l, c) {
  "use strict";
  K();
  var f = (d) => d[d.length - 1];
  c.exports = f;
} });
var ho = W({ "src/language-js/parse/postprocess/visit-node.js"(l, c) {
  "use strict";
  K();
  function f(d, x) {
    if (Array.isArray(d)) {
...
var uo = W({ "src/language-js/parse/postprocess/throw-syntax-error.js"(l, c) {
  "use strict";
  K();
  var f = lr();
  function d(x, g) {
    let { start: A, end: T } = x.loc;
    throw f(g, { start: { line: A.line, column: A.column + 1 }, end: { line: T.line, column: T.column + 1 } });
  }
  c.exports = d;
} });
var lf = W({ "src/language-js/parse/postprocess/typescript.js"(l, c) {
  "use strict";
  K();
  var f = or(), d = ho(), x = uo(), g = { AbstractKeyword: 126, SourceFile: 308, PropertyDeclaration: 169 };
  function A(I) {
  ...
  function T(I) {
    ...
    if (!f(C))
      return;
    let [{ expression: L }] = C, R = A(L), [N, $] = [L.pos, L.end].map((X) => {
      let { line: D, character: _ } = R.getLineAndCharacterOfPosition(X);
      return { line: D + 1, column: _ };
    });
    x({ loc: { start: N, end: $ } }, "Decorators are not valid here.");
  }
  function S(I, C) {
    I.kind !== g.PropertyDeclaration || I.modifiers && !I.modifiers.some((L) => L.kind === g.AbstractKeyword) || I.initializer && C.value === null && x(C, "Abstract property cannot have an initializer");
  }
  function O(I, C) {
    let { esTreeNodeToTSNodeMap: L, tsNodeToESTreeNodeMap: R } = C.tsParseResult;
    d(I, (N) => {
      let $ = L.get(N);
      if (!$)
        return;
  ...
  c.exports = { throwErrorForInvalidNodes: O };
} });
var hf = W({ "src/language-js/parse/postprocess/index.js"(l, c) {
  "use strict";
  K();
  var { locStart: f, locEnd: d } = no(), x = rf(), g = nf(), A = of(), T = ho(), { throwErrorForInvalidNodes: S } = lf(), O = uo();
  function I(N, $) {
    if ($.parser === "typescript" && /@|abstract/.test($.originalText) && S(N, $), $.parser !== "typescript" && $.parser !== "flow" && $.parser !== "acorn" && $.parser !== "espree" && $.parser !== "meriyah") {
    ...
    return N = T(N, (D) => {
      switch (D.type) {
        ...
        case "TSParenthesizedType":
          return x(D.typeAnnotation) || D.typeAnnotation.type === "TSThisType" || (D.typeAnnotation.range = [f(D), d(D)]), D.typeAnnotation;
        ...
        case "ObjectExpression":
          if ($.parser === "typescript") {
            let _ = D.properties.find((h) => h.type === "Property" && h.value.type === "TSEmptyBodyFunctionExpression");
            _ && O(_.value, "Unexpected token.");
          }
          break;
        ...
        case "ExportAllDeclaration": {
          ...
          if ($.parser === "meriyah" && _ && _.type === "Identifier") {
            ...
            (h.startsWith('"') || h.startsWith("'")) && (D.exported = Object.assign(Object.assign({}, D.exported), {}, { type: "Literal", value: D.exported.name, raw: h }));
          }
          break;
        }
        case "PropertyDefinition":
          if ($.parser === "meriyah" && D.static && !D.computed && !D.key) {
            let _ = "static", h = f(D);
            Object.assign(D, { static: false, key: { type: "Identifier", name: _, range: [h, h + _.length] } });
          }
          break;
      }
    }), N;
    function X(D, _) {
      $.originalText[d(_)] !== ";" && (D.range = [f(D), d(_)]);
    }
  }
  function C(N) {
    switch (N.type) {
  ...
  function R(N) {
    return L(N) ? R({ type: "LogicalExpression", operator: N.operator, left: R({ type: "LogicalExpression", operator: N.operator, left: N.left, right: N.right.left, range: [f(N.left), d(N.right.left)] }), right: N.right.right, range: [f(N), d(N)] }) : N;
  }
  c.exports = I;
} });
var co = W({ "node_modules/@babel/parser/lib/index.js"(l) {
  "use strict";
  ...
  var g = { SyntaxError: "BABEL_PARSER_SYNTAX_ERROR", SourceTypeModuleError: "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED" }, A = function(t) {
    ...
    return r === "UpdateExpression" ? O.UpdateExpression[String(e)] : O[r];
...
- Did you mean \`import { "${r}" as foo }\`?`;
  ...
  function D(t) {
    ...
    return function s(i) {
      ...
      return T(SyntaxError, Object.assign({}, e, { loc: a }), { clone() {
        ...
        return s({ loc: new f("line" in u ? u.line : this.loc.line, "column" in u ? u.column : this.loc.column, "index" in u ? u.index : this.loc.index), details: Object.assign({}, this.details, o.details) });
  ...
  function _(t, r) {
    ...
    for (let s of Object.keys(t)) {
      let i = t[s], a = typeof i == "string" ? { message: () => i } : typeof i == "function" ? { message: i } : i, { message: n } = a, o = c(a, X), u = typeof n == "string" ? () => n : n;
      e[s] = D(Object.assign({ code: g.SyntaxError, reasonCode: s, toMessage: u }, r ? { syntaxPlugin: r } : {}, o));
    }
    return e;
  }
  var h = Object.assign({}, _(S), _(C), _(L), _`pipelineOperator`(N)), { defineProperty: Y } = Object, oe = (t, r) => Y(t, r, { enumerable: false, value: t[r] });
  function Z(t) {
    return t.loc.start && oe(t.loc.start, "index"), t.loc.end && oe(t.loc.end, "index"), t;
  }
  var Ee = (t) => class extends t {
    parse() {
      let e = Z(super.parse());
      return this.options.tokens && (e.tokens = e.tokens.map(Z)), e;
    }
    ...
    parseMethod(e, s, i, a, n, o) {
      let u = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : false, p = this.startNode();
      return p.kind = e.kind, p = super.parseMethod(p, s, i, a, n, o, u), p.type = "FunctionExpression", delete p.kind, e.value = p, o === "ClassPrivateMethod" && (e.computed = false), this.finishNode(e, "MethodDefinition");
    }
    parseClassProperty() {
    ...
    finishNodeAt(e, s, i) {
      return Z(super.finishNodeAt(e, s, i));
    }
    resetStartLocation(e, s) {
      super.resetStartLocation(e, s), Z(e);
    }
    resetEndLocation(e) {
      let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.state.lastTokEndLoc;
      super.resetEndLocation(e, s), Z(e);
    }
  }, te = class {
    constructor(t, r) {
      this.token = void 0, this.preserveSpace = void 0, this.token = t, this.preserveSpace = !!r;
    }
  }, U = { brace: new te("{"), j_oTag: new te("<tag"), j_cTag: new te("</tag"), j_expr: new te("<tag>...</tag>", true) };
  U.template = new te("`", true);
  var M = true, v = true, De = true, V = true, Q = true, me = true, fe = class {
    constructor(t) {
  ...
  he[8].updateContext = (t) => {
    t.pop();
  }, he[5].updateContext = he[7].updateContext = he[23].updateContext = (t) => {
    t.push(U.brace);
  }, he[22].updateContext = (t) => {
    t[t.length - 1] === U.template ? t.pop() : t.push(U.template);
  }, he[140].updateContext = (t) => {
    t.push(U.j_expr, U.j_oTag);
  };
  var Wt = "ªµºÀ-ÖØ-öø-ˁˆ-ˑˠ-ˤˬˮͰ-ʹͶͷͺ-ͽͿΆΈ-ΊΌΎ-ΡΣ-ϵϷ-ҁҊ-ԯԱ-Ֆՙՠ-ֈא-תׯ-ײؠ-يٮٯٱ-ۓەۥۦۮۯۺ-ۼۿܐܒ-ܯݍ-ޥޱߊ-ߪߴߵߺࠀ-ࠕࠚࠤࠨࡀ-ࡘࡠ-ࡪࡰ-ࢇࢉ-ࢎࢠ-ࣉऄ-हऽॐक़-ॡॱ-ঀঅ-ঌএঐও-নপ-রলশ-হঽৎড়ঢ়য়-ৡৰৱৼਅ-ਊਏਐਓ-ਨਪ-ਰਲਲ਼ਵਸ਼ਸਹਖ਼-ੜਫ਼ੲ-ੴઅ-ઍએ-ઑઓ-નપ-રલળવ-હઽૐૠૡૹଅ-ଌଏଐଓ-ନପ-ରଲଳଵ-ହଽଡ଼ଢ଼ୟ-ୡୱஃஅ-ஊஎ-ஐஒ-கஙசஜஞடணதந-பம-ஹௐఅ-ఌఎ-ఐఒ-నప-హఽౘ-ౚౝౠౡಀಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹಽೝೞೠೡೱೲഄ-ഌഎ-ഐഒ-ഺഽൎൔ-ൖൟ-ൡൺ-ൿඅ-ඖක-නඳ-රලව-ෆก-ะาำเ-ๆກຂຄຆ-ຊຌ-ຣລວ-ະາຳຽເ-ໄໆໜ-ໟༀཀ-ཇཉ-ཬྈ-ྌက-ဪဿၐ-ၕၚ-ၝၡၥၦၮ-ၰၵ-ႁႎႠ-ჅჇჍა-ჺჼ-ቈቊ-ቍቐ-ቖቘቚ-ቝበ-ኈኊ-ኍነ-ኰኲ-ኵኸ-ኾዀዂ-ዅወ-ዖዘ-ጐጒ-ጕጘ-ፚᎀ-ᎏᎠ-Ᏽᏸ-ᏽᐁ-ᙬᙯ-ᙿᚁ-ᚚᚠ-ᛪᛮ-ᛸᜀ-ᜑᜟ-ᜱᝀ-ᝑᝠ-ᝬᝮ-ᝰក-ឳៗៜᠠ-ᡸᢀ-ᢨᢪᢰ-ᣵᤀ-ᤞᥐ-ᥭᥰ-ᥴᦀ-ᦫᦰ-ᧉᨀ-ᨖᨠ-ᩔᪧᬅ-ᬳᭅ-ᭌᮃ-ᮠᮮᮯᮺ-ᯥᰀ-ᰣᱍ-ᱏᱚ-ᱽᲀ-ᲈᲐ-ᲺᲽ-Ჿᳩ-ᳬᳮ-ᳳᳵᳶᳺᴀ-ᶿḀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼⁱⁿₐ-ₜℂℇℊ-ℓℕ℘-ℝℤΩℨK-ℹℼ-ℿⅅ-ⅉⅎⅠ-ↈⰀ-ⳤⳫ-ⳮⳲⳳⴀ-ⴥⴧⴭⴰ-ⵧⵯⶀ-ⶖⶠ-ⶦⶨ-ⶮⶰ-ⶶⶸ-ⶾⷀ-ⷆⷈ-ⷎⷐ-ⷖⷘ-ⷞ々-〇〡-〩〱-〵〸-〼ぁ-ゖ゛-ゟァ-ヺー-ヿㄅ-ㄯㄱ-ㆎㆠ-ㆿㇰ-ㇿ㐀-䶿一-ꒌꓐ-ꓽꔀ-ꘌꘐ-ꘟꘪꘫꙀ-ꙮꙿ-ꚝꚠ-ꛯꜗ-ꜟꜢ-ꞈꞋ-ꟊꟐꟑꟓꟕ-ꟙꟲ-ꠁꠃ-ꠅꠇ-ꠊꠌ-ꠢꡀ-ꡳꢂ-ꢳꣲ-ꣷꣻꣽꣾꤊ-ꤥꤰ-ꥆꥠ-ꥼꦄ-ꦲꧏꧠ-ꧤꧦ-ꧯꧺ-ꧾꨀ-ꨨꩀ-ꩂꩄ-ꩋꩠ-ꩶꩺꩾ-ꪯꪱꪵꪶꪹ-ꪽꫀꫂꫛ-ꫝꫠ-ꫪꫲ-ꫴꬁ-ꬆꬉ-ꬎꬑ-ꬖꬠ-ꬦꬨ-ꬮꬰ-ꭚꭜ-ꭩꭰ-ꯢ가-힣ힰ-ퟆퟋ-ퟻ豈-舘並-龎ﬀ-ﬆﬓ-ﬗיִײַ-ﬨשׁ-זּטּ-לּמּנּסּףּפּצּ-ﮱﯓ-ﴽﵐ-ﶏﶒ-ﷇﷰ-ﷻﹰ-ﹴﹶ-ﻼＡ-Ｚａ-ｚｦ-ﾾￂ-ￇￊ-ￏￒ-ￗￚ-ￜ", cr = "‌‍·̀-ͯ·҃-֑҇-ׇֽֿׁׂׅׄؐ-ًؚ-٩ٰۖ-ۜ۟-۪ۤۧۨ-ۭ۰-۹ܑܰ-݊ަ-ް߀-߉߫-߽߳ࠖ-࠙ࠛ-ࠣࠥ-ࠧࠩ-࡙࠭-࡛࢘-࢟࣊-ࣣ࣡-ःऺ-़ा-ॏ॑-ॗॢॣ०-९ঁ-ঃ়া-ৄেৈো-্ৗৢৣ০-৯৾ਁ-ਃ਼ਾ-ੂੇੈੋ-੍ੑ੦-ੱੵઁ-ઃ઼ા-ૅે-ૉો-્ૢૣ૦-૯ૺ-૿ଁ-ଃ଼ା-ୄେୈୋ-୍୕-ୗୢୣ୦-୯ஂா-ூெ-ைொ-்ௗ௦-௯ఀ-ఄ఼ా-ౄె-ైొ-్ౕౖౢౣ౦-౯ಁ-ಃ಼ಾ-ೄೆ-ೈೊ-್ೕೖೢೣ೦-೯ೳഀ-ഃ഻഼ാ-ൄെ-ൈൊ-്ൗൢൣ൦-൯ඁ-ඃ්ා-ුූෘ-ෟ෦-෯ෲෳัิ-ฺ็-๎๐-๙ັິ-ຼ່-໎໐-໙༘༙༠-༩༹༵༷༾༿ཱ-྄྆྇ྍ-ྗྙ-ྼ࿆ါ-ှ၀-၉ၖ-ၙၞ-ၠၢ-ၤၧ-ၭၱ-ၴႂ-ႍႏ-ႝ፝-፟፩-፱ᜒ-᜕ᜲ-᜴ᝒᝓᝲᝳ឴-៓៝០-៩᠋-᠍᠏-᠙ᢩᤠ-ᤫᤰ-᤻᥆-᥏᧐-᧚ᨗ-ᨛᩕ-ᩞ᩠-᩿᩼-᪉᪐-᪙᪰-᪽ᪿ-ᫎᬀ-ᬄ᬴-᭄᭐-᭙᭫-᭳ᮀ-ᮂᮡ-ᮭ᮰-᮹᯦-᯳ᰤ-᰷᱀-᱉᱐-᱙᳐-᳔᳒-᳨᳭᳴᳷-᳹᷀-᷿‿⁀⁔⃐-⃥⃜⃡-⃰⳯-⵿⳱ⷠ-〪ⷿ-゙゚〯꘠-꘩꙯ꙴ-꙽ꚞꚟ꛰꛱ꠂ꠆ꠋꠣ-ꠧ꠬ꢀꢁꢴ-ꣅ꣐-꣙꣠-꣱ꣿ-꤉ꤦ-꤭ꥇ-꥓ꦀ-ꦃ꦳-꧀꧐-꧙ꧥ꧰-꧹ꨩ-ꨶꩃꩌꩍ꩐-꩙ꩻ-ꩽꪰꪲ-ꪴꪷꪸꪾ꪿꫁ꫫ-ꫯꫵ꫶ꯣ-ꯪ꯬꯭꯰-꯹ﬞ︀-️︠-︯︳︴﹍-﹏０-９＿", bo = new RegExp("[" + Wt + "]"), Co = new RegExp("[" + Wt + cr + "]");
  Wt = cr = null;
  ...
  function ge(t) {
    return t < 65 ? t === 36 : t <= 90 ? true : t < 97 ? t === 95 : t <= 122 ? true : t <= 65535 ? t >= 170 && bo.test(String.fromCharCode(t)) : Gt(t, pr);
  }
  function He(t) {
    return t < 48 ? t === 36 : t < 58 ? true : t < 65 ? false : t <= 90 ? true : t < 97 ? t === 95 : t <= 122 ? true : t <= 65535 ? t >= 170 && Co.test(String.fromCharCode(t)) : Gt(t, pr) || Gt(t, So);
  }
  var Jt = { keyword: ["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete"], strict: ["implements", "interface", "let", "package", "private", "protected", "public", "static", "yield"], strictBind: ["eval", "arguments"] }, wo = new Set(Jt.keyword), Io = new Set(Jt.strict), No = new Set(Jt.strictBind);
  function fr(t, r) {
    return r && t === "await" || t === "enum";
  }
  function dr(t, r) {
    return fr(t, r) || Io.has(t);
  }
  function mr(t) {
    return No.has(t);
  }
  ...
  var $e = 0, ze = 1, Pe = 2, Xt = 4, xr = 8, ft = 16, gr = 32, Fe = 64, dt = 128, Ve = 256, mt = ze | Pe | dt | Ve, Ae = 1, Le = 2, Pr = 4, Ce = 8, yt = 16, Ar = 64, xt = 128, Yt = 256, Qt = 512, Zt = 1024, es = 2048, et = 4096, Tr = Ae | Le | Ce | xt, Oe = Ae | 0 | Ce | 0, gt = Ae | 0 | Pr | 0, vr = Ae | 0 | yt | 0, Oo = 0 | Le | 0 | xt, Mo = 0 | Le | 0 | 0, Er = Ae | Le | Ce | Yt, br = 0 | Zt, Se = 0 | Ar, Bo = Ae | 0 | 0 | Ar, _o = Er | Qt, Ro = 0 | Zt, Cr = 0 | Le | 0 | et, jo = es, Pt = 4, ts = 2, ss = 1, rs = ts | ss, qo = ts | Pt, Uo = ss | Pt, Ho = ts, $o = ss, is = 0, as = class {
    constructor(t) {
    ...
    get inTopLevel() {
      return (this.currentScope().flags & ze) > 0;
    }
    get inFunction() {
      return (this.currentVarScopeFlags() & Pe) > 0;
    }
    get allowSuper() {
      return (this.currentThisScopeFlags() & ft) > 0;
    }
    ...
    treatFunctionsAsVarInScope(t) {
      return !!(t.flags & (Pe | dt) || !this.parser.inModule && t.flags & ze);
    }
    declareName(t, r, e) {
      let s = this.currentScope();
      if (r & Ce || r & yt)
        this.checkRedeclarationInScope(s, t, r, e), r & yt ? s.functions.add(t) : s.lexical.add(t), r & Ce && this.maybeExportDefined(s, t);
      else if (r & Pr)
        for (let i = this.scopeStack.length - 1; i >= 0 && (s = this.scopeStack[i], this.checkRedeclarationInScope(s, t, r, e), s.var.add(t), this.maybeExportDefined(s, t), !(s.flags & mt)); --i)
          ;
      this.parser.inModule && s.flags & ze && this.undefinedExports.delete(t);
    }
    maybeExportDefined(t, r) {
      this.parser.inModule && t.flags & ze && this.undefinedExports.delete(r);
    }
    ...
    isRedeclaredInScope(t, r, e) {
      return e & Ae ? e & Ce ? t.lexical.has(r) || t.functions.has(r) || t.var.has(r) : e & yt ? t.lexical.has(r) || !this.treatFunctionsAsVarInScope(t) && t.var.has(r) : t.lexical.has(r) && !(t.flags & xr && t.lexical.values().next().value === r) || !this.treatFunctionsAsVarInScope(t) && t.functions.has(r) : false;
    }
    checkLocalExport(t) {
    ...
    isRedeclaredInScope(t, r, e) {
      return super.isRedeclaredInScope(t, r, e) ? true : e & es ? !t.declareFunctions.has(r) && (t.lexical.has(r) || t.functions.has(r)) : false;
    }
    checkLocalExport(t) {
  ...
  function st(t, r, e) {
    ...
    for (; s === null && i > 0; )
      s = r[--i];
    s === null || s.start > e.start ? tt(t, e.comments) : Sr(s, e.comments);
  }
  var Go = class extends Ko {
    addComment(t) {
    ...
    finalizeComment(t) {
      ...
      if (t.leadingNode !== null || t.trailingNode !== null)
        t.leadingNode !== null && Sr(t.leadingNode, r), t.trailingNode !== null && Wo(t.trailingNode, r);
      else {
  ...
  var Ir = class {
    ...
    clone(t) {
      let r = new Ir(), e = Object.keys(this);
    ...
    return r >= 48 && r <= 57;
  }, Nr = { decBinOct: /* @__PURE__ */ new Set([46, 66, 69, 79, 95, 98, 101, 111]), hex: /* @__PURE__ */ new Set([46, 88, 95, 120]) }, Tt = { bin: (t) => t === 48 || t === 49, oct: (t) => t >= 48 && t <= 55, dec: (t) => t >= 48 && t <= 57, hex: (t) => t >= 48 && t <= 57 || t >= 65 && t <= 70 || t >= 97 && t <= 102 };
  function kr(t, r, e, s, i, a) {
    let n = e, o = s, u = i, p = "", m = null, y = e, { length: P } = r;
    for (; ; ) {
      if (e >= P) {
        a.unterminated(n, o, u), p += r.slice(y, e);
        break;
      }
      ...
      if (b === 92) {
        p += r.slice(y, e);
        let B = Zo(r, e, s, i, t === "template", a);
        B.ch === null && !m ? m = { pos: e, lineStart: s, curLine: i } : p += B.ch, { pos: e, lineStart: s, curLine: i } = B, y = e;
      } else
        b === 8232 || b === 8233 ? (++e, ++i, s = e) : b === 10 || b === 13 ? t === "template" ? (p += r.slice(y, e) + `
`, ++e, b === 13 && r.charCodeAt(e) === 10 && ++e, ++i, y = s = e) : a.unterminated(n, o, u) : ++e;
    }
  ...
  function Zo(t, r, e, s, i, a) {
    let n = !i;
    r++;
    let o = (p) => ({ pos: r, ch: p, lineStart: e, curLine: s }), u = t.charCodeAt(r++);
    switch (u) {
      case 110:
        return o(`
`);
      ...
      case 120: {
        let p;
        return { code: p, pos: r } = hs(t, r, e, s, 2, false, n, a), o(p === null ? null : String.fromCharCode(p));
      }
      case 117: {
        let p;
        return { code: p, pos: r } = Fr(t, r, e, s, n, a), o(p === null ? null : String.fromCodePoint(p));
      }
      case 116:
        return o("	");
      case 98:
      ...
      default:
        if (u >= 48 && u <= 55) {
          let p = r - 1, y = t.slice(p, r + 2).match(/^[0-7]+/)[0], P = parseInt(y, 8);
          P > 255 && (y = y.slice(0, -1), P = parseInt(y, 8)), r += y.length - 1;
  ...
  function hs(t, r, e, s, i, a, n, o) {
    let u = r, p;
    return { n: p, pos: r } = Dr(t, r, e, s, 16, i, a, false, o, !n), p === null && (n ? o.invalidEscapeSequence(u, e, s) : r = u - 1), { code: p, pos: r };
  }
  function Dr(t, r, e, s, i, a, n, o, u, p) {
    let m = r, y = i === 16 ? Nr.hex : Nr.decBinOct, P = i === 16 ? Tt.hex : i === 10 ? Tt.dec : i === 8 ? Tt.oct : Tt.bin, b = false, B = 0;
    for (let q = 0, se = a == null ? 1 / 0 : a; q < se; ++q) {
      let re = t.charCodeAt(r), ee;
      if (re === 95 && o !== "bail") {
        let ae = t.charCodeAt(r - 1), Je = t.charCodeAt(r + 1);
        if (o) {
          if (Number.isNaN(Je) || !P(Je) || y.has(ae) || y.has(Je)) {
            if (p)
              return { n: null, pos: r };
      ...
      if (re >= 97 ? ee = re - 97 + 10 : re >= 65 ? ee = re - 65 + 10 : Yo(re) ? ee = re - 48 : ee = 1 / 0, ee >= i) {
        if (ee <= 9 && p)
          return { n: null, pos: r };
        if (ee <= 9 && u.invalidDigit(r, e, s, i))
          ee = 0;
        else if (n)
          ee = 0, b = true;
        else
    ...
    return r === m || a != null && r - m !== a || b ? { n: null, pos: r } : { n: B, pos: r };
  }
  function Fr(t, r, e, s, i, a) {
    let n = t.charCodeAt(r), o;
    if (n === 123) {
      if (++r, { code: o, pos: r } = hs(t, r, e, s, t.indexOf("}", r) - r, true, i, a), ++r, o !== null && o > 1114111)
        if (i)
          a.invalidCodePoint(r, e, s);
        else
          return { code: null, pos: r };
    } else
      ({ code: o, pos: r } = hs(t, r, e, s, 4, false, i, a));
    return { code: o, pos: r };
  }
  var el = ["at"], tl = ["at"];
  function it(t, r, e) {
  ...
  var sl = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), we = class {
    ...
    constructor(t, r) {
      super(), this.isLookahead = void 0, this.tokens = [], this.errorHandlers_readInt = { invalidDigit: (e, s, i, a) => this.options.errorRecovery ? (this.raise(h.InvalidDigit, { at: it(e, s, i), radix: a }), true) : false, numericSeparatorInEscapeSequence: this.errorBuilder(h.NumericSeparatorInEscapeSequence), unexpectedNumericSeparator: this.errorBuilder(h.UnexpectedNumericSeparator) }, this.errorHandlers_readCodePoint = Object.assign({}, this.errorHandlers_readInt, { invalidEscapeSequence: this.errorBuilder(h.InvalidEscapeSequence), invalidCodePoint: this.errorBuilder(h.InvalidCodePoint) }), this.errorHandlers_readStringContents_string = Object.assign({}, this.errorHandlers_readCodePoint, { strictNumericEscape: (e, s, i) => {
        ...
        throw this.raise(h.UnterminatedTemplate, { at: it(e, s, i) });
      } }), this.state = new Ir(), this.state.init(t), this.input = r, this.length = r.length, this.isLookahead = false;
    }
    pushToken(t) {
    ...
    nextTokenStartSince(t) {
      return ls.lastIndex = t, ls.test(this.input) ? ls.lastIndex : t;
    }
    lookaheadCharCode() {
    ...
    skipBlockComment(t) {
      ...
      for (this.state.pos = s + t.length, At.lastIndex = e + 2; At.test(this.input) && At.lastIndex <= s; )
        ++this.state.curLine, this.state.lineStart = At.lastIndex;
      if (this.isLookahead)
        return;
    ...
    skipLineComment(t) {
      ...
      if (this.state.pos < this.length)
        for (; !rt(s) && ++this.state.pos < this.length; )
    ...
    readToken_interpreter() {
      ...
      for (this.state.pos += 1; !rt(t) && ++this.state.pos < this.length; )
    ...
    readRegexp() {
      ...
      for (; ; ++i) {
        if (i >= this.length)
          throw this.raise(h.UnterminatedRegExp, { at: x(t, 1) });
      ...
      let n = "", o = () => x(t, i + 2 - r);
      for (; i < this.length; ) {
        let u = this.codePointAtPos(i), p = String.fromCharCode(u);
        if (sl.has(u))
          u === 118 ? (this.expectPlugin("regexpUnicodeSets", o()), n.includes("u") && this.raise(h.IncompatibleRegExpUVFlags, { at: o() })) : u === 117 && n.includes("v") && this.raise(h.IncompatibleRegExpUVFlags, { at: o() }), n.includes(p) && this.raise(h.DuplicateRegExpFlags, { at: o() });
        else if (He(u) || u === 92)
    ...
    readInt(t, r) {
      let e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, s = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true, { n: i, pos: a } = Dr(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, r, e, s, this.errorHandlers_readInt, false);
    ...
    readRadixNumber(t) {
      ...
      s == null && this.raise(h.InvalidDigit, { at: x(r, 2), radix: t });
    ...
    readNumber(t) {
      ...
      if (u) {
        ...
        if (this.recordStrictModeErrors(h.StrictOctalLiteral, { at: e }), !this.state.strict) {
          let b = P.indexOf("_");
          b > 0 && this.raise(h.ZeroDigitNumericSeparator, { at: x(e, b) });
        }
        o = u && !/[89]/.test(P);
      }
      let p = this.input.charCodeAt(this.state.pos);
      if (p === 46 && !o && (++this.state.pos, this.readInt(10), s = true, p = this.input.charCodeAt(this.state.pos)), (p === 69 || p === 101) && !o && (p = this.input.charCodeAt(++this.state.pos), (p === 43 || p === 45) && ++this.state.pos, this.readInt(10) === null && this.raise(h.InvalidOrMissingExponent, { at: e }), s = true, n = true, p = this.input.charCodeAt(this.state.pos)), p === 110 && ((s || u) && this.raise(h.InvalidBigIntLiteral, { at: e }), ++this.state.pos, i = true), p === 109 && (this.expectPlugin("decimal", this.state.curPosition()), (n || u) && this.raise(h.InvalidDecimal, { at: e }), ++this.state.pos, a = true), ge(this.codePointAtPos(this.state.pos)))
        throw this.raise(h.NumberIdentifier, { at: this.state.curPosition() });
      ...
      let y = o ? parseInt(m, 8) : parseFloat(m);
      this.finishToken(132, y);
    }
    readCodePoint(t) {
      let { code: r, pos: e } = Fr(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, this.errorHandlers_readCodePoint);
      return this.state.pos = e, r;
    }
    readString(t) {
      let { str: r, pos: e, curLine: s, lineStart: i } = kr(t === 34 ? "double" : "single", this.input, this.state.pos + 1, this.state.lineStart, this.state.curLine, this.errorHandlers_readStringContents_string);
    ...
    readTemplateToken() {
      let t = this.input[this.state.pos], { str: r, firstInvalidLoc: e, pos: s, curLine: i, lineStart: a } = kr("template", this.input, this.state.pos + 1, this.state.lineStart, this.state.curLine, this.errorHandlers_readStringContents_template);
    ...
    readWord1(t) {
      ...
      for (t !== void 0 && (this.state.pos += t <= 65535 ? 1 : 2); this.state.pos < this.length; ) {
        ...
        if (He(i))
          ...
          let a = this.state.curPosition(), n = this.state.pos === e ? ge : He;
    ...
    readWord(t) {
      let r = this.readWord1(t), e = le.get(r);
      e !== void 0 ? this.finishToken(e, be(e)) : this.finishToken(130, r);
    }
    checkKeywordEscapes() {
      let { type: t } = this.state;
      Kt(t) && this.state.containsEsc && this.raise(h.InvalidEscapedReservedWord, { at: this.state.startLoc, reservedWord: be(t) });
    }
    raise(t, r) {
      let { at: e } = r, s = c(r, el), i = e instanceof f ? e : e.loc.start, a = t({ loc: i, details: s });
      if (!this.options.errorRecovery)
        throw a;
      return this.isLookahead || this.state.errors.push(a), a;
    }
    raiseOverwrite(t, r) {
      let { at: e } = r, s = c(r, tl), i = e instanceof f ? e : e.loc.start, a = i.index, n = this.state.errors;
    ...
    unexpected(t, r) {
      throw this.raise(h.UnexpectedToken, { expected: r ? be(r) : null, at: t != null ? t : this.state.startLoc });
    }
    expectPlugin(t, r) {
      if (this.hasPlugin(t))
        return true;
    ...
    declarePrivateName(t, r, e) {
      ...
      if (r & rs) {
        let o = n && i.get(t);
        if (o) {
          let u = o & Pt, p = r & Pt, m = o & rs, y = r & rs;
          n = m === y || u !== p, n || i.delete(t);
        } else
          n || i.set(t, r);
      }
    ...
    constructor(t) {
      this.parser = void 0, this.stack = [new vt()], this.parser = t;
    }
    enter(t) {
      this.stack.push(t);
    }
    ...
    recordAsyncArrowParametersError(t) {
      ...
      for (; i.canBeArrowParameterDeclaration(); )
        i.type === us && i.recordDeclarationError(h.AwaitBindingIdentifier, { at: r }), i = e[--s];
    }
    validateAsPattern() {
  ...
  var Ke = 0, _r = 1, Et = 2, Rr = 4, We = 8, cl = class {
    constructor() {
      this.stacks = [];
    }
    enter(t) {
  ...
  var pl = class extends rl {
    ...
    hasPrecedingLineBreak() {
      return os.test(this.input.slice(this.state.lastTokEndLoc.index, this.state.start));
    }
    hasFollowingLineBreak() {
      return wr.lastIndex = this.state.end, wr.test(this.input);
    }
    isLineTerminator() {
    ...
    initializeScopes() {
      ...
      this.prodParam = new cl();
      let o = this.classScope;
      this.classScope = new al(this);
      let u = this.expressionScope;
      return this.expressionScope = new ol(this), () => {
    ...
    enterInitialScopes() {
      let t = Ke;
      this.inModule && (t |= Et), this.scope.enter(ze), this.prodParam.enter(t);
    }
  ...
  cs.__clone = function() {
    let t = new St(void 0, this.start, this.loc.start), r = Object.keys(this);
  ...
  function Te(t) {
    let { type: r, start: e, end: s, loc: i, range: a, extra: n, name: o } = t, u = Object.create(cs);
  ...
  var gl = { const: "declare export var", let: "declare export var", type: "export type", interface: "export interface" };
  function Pl(t, r) {
    let e = [], s = [];
  ...
  var Al = /\*?\s*@((?:no)?flow)\b/, Tl = (t) => class extends t {
    constructor() {
    ...
    flowParseDeclareVariable(e) {
      return this.next(), e.id = this.flowParseTypeAnnotatableIdentifier(true), this.scope.declareName(e.id.name, gt, e.id.loc.start), this.semicolon(), this.finishNode(e, "DeclareVariable");
    }
    flowParseDeclareModule(e) {
      this.scope.enter($e), this.match(131) ? e.id = super.parseExprAtom() : e.id = this.parseIdentifier();
      ...
      let a = null, n = false;
      return i.forEach((o) => {
        xl(o) ? (a === "CommonJS" && this.raise(F.AmbiguousDeclareModuleKind, { at: o }), a = "ES") : o.type === "DeclareModuleExports" && (n && this.raise(F.DuplicateDeclareModuleExports, { at: o }), a === "ES" && this.raise(F.AmbiguousDeclareModuleKind, { at: o }), a = "CommonJS", n = true);
    ...
    flowParseDeclareExportDeclaration(e, s) {
      ...
      if (this.match(75) || this.isLet() || (this.isContextual(128) || this.isContextual(127)) && !s) {
        ...
        throw this.raise(F.UnsupportedDeclareExportKind, { at: this.state.startLoc, unsupportedExportKind: i, suggestion: gl[i] });
      }
    ...
    flowParseInterfaceish(e) {
      let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
      if (e.id = this.flowParseRestrictedIdentifier(!s, true), this.scope.declareName(e.id.name, s ? vr : Oe, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.extends = [], e.implements = [], e.mixins = [], this.eat(81))
        do
    ...
    checkReservedType(e, s, i) {
      !yl.has(e) || this.raise(i ? F.AssignReservedType : F.UnexpectedReservedType, { at: s, reservedType: e });
    }
    ...
    flowParseTypeAlias(e) {
      return e.id = this.flowParseRestrictedIdentifier(false, true), this.scope.declareName(e.id.name, Oe, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.right = this.flowParseTypeInitialiser(29), this.semicolon(), this.finishNode(e, "TypeAlias");
    }
    flowParseOpaqueType(e, s) {
      return this.expectContextual(128), e.id = this.flowParseRestrictedIdentifier(true, true), this.scope.declareName(e.id.name, Oe, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.supertype = null, this.match(14) && (e.supertype = this.flowParseTypeInitialiser(14)), e.impltype = null, s || (e.impltype = this.flowParseTypeInitialiser(29)), this.semicolon(), this.finishNode(e, "OpaqueType");
    }
    ...
    flowParseObjectType(e) {
      ...
      let m, y, P = false;
      for (i && this.match(6) ? (this.expect(6), m = 9, y = true) : (this.expect(5), m = 8, y = false), p.exact = y; !this.match(m); ) {
        let B = false, q = null, se = null, re = this.startNode();
        if (n && this.isContextual(116)) {
          let ae = this.lookahead();
          ae.type !== 14 && ae.type !== 17 && (this.next(), q = this.state.startLoc, s = false);
        }
        if (s && this.isContextual(104)) {
          let ae = this.lookahead();
          ae.type !== 14 && ae.type !== 17 && (this.next(), B = true);
        }
        let ee = this.flowParseVariance();
        if (this.eat(0))
          q != null && this.unexpected(q), this.eat(0) ? (ee && this.unexpected(ee.loc.start), p.internalSlots.push(this.flowParseObjectTypeInternalSlot(re, B))) : p.indexers.push(this.flowParseObjectTypeIndexer(re, B, ee));
        else if (this.match(10) || this.match(47))
          q != null && this.unexpected(q), ee && this.unexpected(ee.loc.start), p.callProperties.push(this.flowParseObjectTypeCallProperty(re, B));
        else {
          let ae = "init";
          if (this.isContextual(98) || this.isContextual(103)) {
            let Yl = this.lookahead();
            hr(Yl.type) && (ae = this.state.value, this.next());
          }
          let Je = this.flowParseObjectTypeProperty(re, B, q, ee, ae, a, o != null ? o : !y);
          Je === null ? (P = true, se = this.state.lastTokStartLoc) : p.properties.push(Je);
        }
        this.flowObjectTypeSemicolon(), se && !this.match(8) && !this.match(9) && this.raise(F.UnexpectedExplicitInexactInObject, { at: se });
      }
      this.expect(m), a && (p.inexact = P);
      let b = this.finishNode(p, "ObjectTypeAnnotation");
      return this.state.inType = u, b;
    }
    flowParseObjectTypeProperty(e, s, i, a, n, o, u) {
      if (this.eat(21))
        return this.match(12) || this.match(13) || this.match(8) || this.match(9) ? (o ? u || this.raise(F.InexactInsideExact, { at: this.state.lastTokStartLoc }) : this.raise(F.InexactInsideNonObject, { at: this.state.lastTokStartLoc }), a && this.raise(F.InexactVariance, { at: a }), null) : (o || this.raise(F.UnexpectedSpreadType, { at: this.state.lastTokStartLoc }), i != null && this.unexpected(i), a && this.raise(F.SpreadVariance, { at: a }), e.argument = this.flowParseType(), this.finishNode(e, "ObjectTypeSpreadProperty"));
      {
    ...
    flowCheckGetterSetterParams(e) {
      ...
      e.value.this && this.raise(e.kind === "get" ? F.GetterMayNotHaveThisParam : F.SetterMayNotHaveThisParam, { at: e.value.this }), i !== s && this.raise(e.kind === "get" ? h.BadGetterArity : h.BadSetterArity, { at: e }), e.kind === "set" && e.value.rest && this.raise(h.BadSetterRestParameter, { at: e });
    }
    ...
    flowParseFunctionTypeParam(e) {
      ...
      return o.type === 14 || o.type === 17 ? (u && !e && this.raise(F.ThisParamMustBeFirst, { at: n }), s = this.parseIdentifier(u), this.eat(17) && (i = true, u && this.raise(F.ThisParamMayNotBeOptional, { at: n })), a = this.flowParseTypeInitialiser()) : a = this.flowParseType(), n.name = s, n.optional = i, n.typeAnnotation = a, this.finishNode(n, "FunctionTypeParam");
    }
    ...
    shouldParseExportDeclaration() {
      ...
      return ur(e) || this.shouldParseEnums() && e === 124 ? !this.state.containsEsc : super.shouldParseExportDeclaration();
    }
    isExportDefaultSpecifier() {
      let { type: e } = this.state;
      return ur(e) || this.shouldParseEnums() && e === 124 ? this.state.containsEsc : super.isExportDefaultSpecifier();
    }
    ...
    parseConditional(e, s, i) {
      ...
      this.expect(17);
      let a = this.state.clone(), n = this.state.noArrowAt, o = this.startNodeAt(s), { consequent: u, failed: p } = this.tryParseConditionalConsequent(), [m, y] = this.getArrowLikeExpressions(u);
      if (p || y.length > 0) {
        let P = [...n];
        if (y.length > 0) {
          ...
          for (let b = 0; b < y.length; b++)
            P.push(y[b].start);
          ({ consequent: u, failed: p } = this.tryParseConditionalConsequent()), [m, y] = this.getArrowLikeExpressions(u);
        }
        p && m.length > 1 && this.raise(F.AmbiguousConditionalArrow, { at: a.startLoc }), p && m.length === 1 && (this.state = a, P.push(m[0].start), this.state.noArrowAt = P, { consequent: u, failed: p } = this.tryParseConditionalConsequent());
      }
    ...
    getArrowLikeExpressions(e, s) {
      ...
      return s ? (a.forEach((n) => this.finishArrowValidation(n)), [a, []]) : Pl(a, (n) => n.params.every((o) => this.isAssignable(o, true)));
    }
    finishArrowValidation(e) {
      var s;
      this.toAssignableList(e.params, (s = e.extra) == null ? void 0 : s.trailingCommaLoc, false), this.scope.enter(Pe | Xt), super.checkParams(e, false, true), this.scope.exit();
    }
    ...
    pushClassMethod(e, s, i, a, n, o) {
      if (s.variance && this.unexpected(s.variance.loc.start), delete s.variance, this.match(47) && (s.typeParameters = this.flowParseTypeParameterDeclaration()), super.pushClassMethod(e, s, i, a, n, o), s.params && n) {
        let u = s.params;
        u.length > 0 && this.isThisParam(u[0]) && this.raise(F.ThisParamBannedInConstructor, { at: s });
    ...
    parseObjPropValue(e, s, i, a, n, o, u) {
      ...
      let m = super.parseObjPropValue(e, s, i, a, n, o, u);
    ...
    shouldParseDefaultImport(e) {
      return ps(e) ? jr(this.state.type) : super.shouldParseDefaultImport(e);
    }
    ...
    parseImportSpecifierLocal(e, s, i) {
      s.local = ps(e) ? this.flowParseRestrictedIdentifier(true, true) : this.parseIdentifier(), e.specifiers.push(this.finishImportSpecifier(s, i));
    }
    maybeParseDefaultImportSpecifier(e) {
      ...
      if (this.match(87) ? s = "typeof" : this.isContextual(128) && (s = "type"), s) {
        ...
        s === "type" && a === 55 && this.unexpected(null, i.type), (jr(a) || a === 5 || a === 55) && (this.next(), e.importKind = s);
      }
    ...
    parseImportSpecifier(e, s, i, a, n) {
      ...
      if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
        let y = this.parseIdentifier(true);
        u !== null && !ye(this.state.type) ? (e.imported = y, e.importKind = u, e.local = Te(y)) : (e.imported = o, e.importKind = null, e.local = this.parseIdentifier());
      } else {
        if (u !== null && ye(this.state.type))
    ...
    parseMaybeAssign(e, s) {
      ...
      if ((i = n) != null && i.error || this.match(47)) {
        ...
        let p, m = this.tryParse((P) => {
          ...
          let B = this.forwardNoArrowParamsConversionAt(p, () => {
            let se = super.parseMaybeAssign(e, s);
            return this.resetStartLocationFromNode(se, p), se;
          });
          (b = B.extra) != null && b.parenthesized && P();
          let q = this.maybeUnwrapTypeCastExpression(B);
          return q.type !== "ArrowFunctionExpression" && P(), q.typeParameters = p, this.resetStartLocationFromNode(q, p), B;
        }, a), y = null;
        ...
        if (y)
          return this.state = m.failState, y;
        throw (u = n) != null && u.thrown ? n.error : m.thrown ? m.error : this.raise(F.UnexpectedTokenAfterTypeParameter, { at: p });
      }
    ...
    flowEnumMembers(e) {
      ...
      for (; !this.match(8); ) {
        ...
        let u = this.startNode(), { id: p, init: m } = this.flowEnumMemberRaw(), y = p.name;
        if (y === "")
          continue;
        /^[a-z]/.test(y) && this.raise(F.EnumInvalidMemberName, { at: p, memberName: y, suggestion: y[0].toUpperCase() + y.slice(1), enumName: s }), a.has(y) && this.raise(F.EnumDuplicateMemberName, { at: p, memberName: y, enumName: s }), a.add(y);
        let P = { enumName: s, explicitType: i, memberName: y };
        switch (u.id = p, m.type) {
          case "boolean": {
            this.flowEnumCheckExplicitTypeMismatch(m.loc, P, "boolean"), u.init = m.value, n.booleanMembers.push(this.finishNode(u, "EnumBooleanMember"));
            break;
          }
          case "number": {
            this.flowEnumCheckExplicitTypeMismatch(m.loc, P, "number"), u.init = m.value, n.numberMembers.push(this.finishNode(u, "EnumNumberMember"));
            break;
          }
          case "string": {
            this.flowEnumCheckExplicitTypeMismatch(m.loc, P, "string"), u.init = m.value, n.stringMembers.push(this.finishNode(u, "EnumStringMember"));
            break;
          }
          case "invalid":
    ...
    flowEnumBody(e, s) {
      ...
      switch (e.hasUnknownMembers = u, n) {
        ...
        default: {
          ...
          let m = o.booleanMembers.length, y = o.numberMembers.length, P = o.stringMembers.length, b = o.defaultedMembers.length;
          if (!m && !y && !P && !b)
            return p();
          if (!m && !y)
          ...
          if (!y && !P && m >= b) {
            for (let B of o.defaultedMembers)
              this.flowEnumErrorBooleanMemberNotInitialized(B.loc.start, { enumName: i, memberName: B.id.name });
            return e.members = o.booleanMembers, this.expect(8), this.finishNode(e, "EnumBooleanBody");
          } else if (!m && !P && y >= b) {
            for (let B of o.defaultedMembers)
              this.flowEnumErrorNumberMemberNotInitialized(B.loc.start, { enumName: i, memberName: B.id.name });
  ...
  var El = (t) => class extends t {
    jsxReadToken() {
      ...
      for (; ; ) {
        if (this.state.pos >= this.length)
          throw this.raise(Me.UnterminatedJsxContent, { at: this.state.startLoc });
        let i = this.input.charCodeAt(this.state.pos);
        switch (i) {
          case 60:
          case 123:
          ...
          case 125:
          default:
            rt(i) ? (e += this.input.slice(s, this.state.pos), e += this.jsxReadNewLine(true), s = this.state.pos) : ++this.state.pos;
        }
      }
    }
    jsxReadNewLine(e) {
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
    ...
    jsxReadString(e) {
      ...
      for (; ; ) {
        ...
        if (a === e)
          break;
        a === 38 ? (s += this.input.slice(i, this.state.pos), s += this.jsxReadEntity(), i = this.state.pos) : rt(a) ? (s += this.input.slice(i, this.state.pos), s += this.jsxReadNewLine(false), i = this.state.pos) : ++this.state.pos;
      }
    ...
    jsxReadEntity() {
      ...
      if (this.codePointAtPos(this.state.pos) === 35) {
        ...
        for (; s++ < 10 && this.state.pos < this.length && !(i = this.codePointAtPos(this.state.pos) == 59); )
          ++this.state.pos;
        if (i) {
          let a = this.input.slice(e, this.state.pos), n = vl[a];
          if (++this.state.pos, n)
            return n;
        }
      }
    ...
    jsxParseIdentifier() {
      let e = this.startNode();
      return this.match(138) ? e.name = this.state.value : Kt(this.state.type) ? e.name = be(this.state.type) : this.unexpected(), this.next(), this.finishNode(e, "JSXIdentifier");
    }
    ...
    jsxParseAttributeValue() {
      ...
      switch (this.state.type) {
        case 5:
          return e = this.startNode(), this.setContext(U.brace), this.next(), e = this.jsxParseExpressionContainer(e, U.j_oTag), e.expression.type === "JSXEmptyExpression" && this.raise(Me.AttributeIsEmpty, { at: e }), e;
        case 140:
        case 131:
          return this.parseExprAtom();
        default:
          throw this.raise(Me.UnsupportedJsxValue, { at: this.state.startLoc });
      }
    }
    ...
    jsxParseElementAt(e) {
      ...
      if (!a.selfClosing) {
        ...
        Ie(a) && !Ie(n) && n !== null ? this.raise(Me.MissingClosingTagFragment, { at: n }) : !Ie(a) && Ie(n) ? this.raise(Me.MissingClosingTagElement, { at: n, openingTagName: Ge(a.name) }) : !Ie(a) && !Ie(n) && Ge(n.name) !== Ge(a.name) && this.raise(Me.MissingClosingTagElement, { at: n, openingTagName: Ge(a.name) });
      }
      if (Ie(a) ? (s.openingFragment = a, s.closingFragment = n) : (s.openingElement = a, s.closingElement = n), s.children = i, this.match(47))
        throw this.raise(Me.UnwrappedAdjacentJSXElements, { at: this.state.startLoc });
      return Ie(a) ? this.finishNode(s, "JSXFragment") : this.finishNode(s, "JSXElement");
    }
    jsxParseElement() {
    ...
    updateContext(e) {
      ...
      if (i === 56 && e === 140)
        ...
        this.state.canStartJSXElement = mo(i);
    }
  }, bl = class extends as {
    constructor() {
    ...
    enter(t) {
      t == Ve && this.importsStack.push(/* @__PURE__ */ new Set()), super.enter(t);
    }
    exit() {
      let t = super.exit();
      return t == Ve && this.importsStack.pop(), t;
    }
    hasImport(t, r) {
    ...
    declareName(t, r, e) {
      ...
      super.declareName(t, r, e), r & Le && (r & Ae || (this.checkRedeclarationInScope(s, t, r, e), this.maybeExportDefined(s, t)), s.types.add(t)), r & Yt && s.enums.add(t), r & Qt && s.constEnums.add(t), r & xt && s.classes.add(t);
    }
    isRedeclaredInScope(t, r, e) {
      if (t.enums.has(r)) {
        if (e & Yt) {
          let s = !!(e & Qt), i = t.constEnums.has(r);
          return s !== i;
        }
        return true;
      }
      return e & xt && t.classes.has(r) ? t.lexical.has(r) ? !!(e & Ae) : false : e & Le && t.types.has(r) ? true : super.isRedeclaredInScope(t, r, e);
    }
    checkLocalExport(t) {
      let { name: r } = t;
      if (this.hasImport(r))
  ...
  }, Sl = (t, r) => Object.hasOwnProperty.call(t, r) && t[r];
  function wl(t) {
    if (t == null)
  ...
  var kl = (t) => class extends t {
    ...
    tsParseModifiers(e) {
      let { modified: s, allowedModifiers: i, disallowedModifiers: a, stopOnStartOfClassStaticBlock: n, errorTemplate: o = w.InvalidModifierOnTypeMember } = e, u = (m, y, P, b) => {
        y === P && s[b] && this.raise(w.InvalidModifiersOrder, { at: m, orderedModifiers: [P, b] });
      }, p = (m, y, P, b) => {
        (s[P] && y === b || s[b] && y === P) && this.raise(w.IncompatibleModifiers, { at: m, modifiers: [P, b] });
      };
      for (; ; ) {
        let { startLoc: m } = this.state, y = this.tsParseModifier(i.concat(a != null ? a : []), n);
        if (!y)
          break;
        Ur(y) ? s.accessibility ? this.raise(w.DuplicateAccessibilityModifier, { at: m, modifier: y }) : (u(m, y, y, "override"), u(m, y, y, "static"), u(m, y, y, "readonly"), s.accessibility = y) : Nl(y) ? (s[y] && this.raise(w.DuplicateModifier, { at: m, modifier: y }), s[y] = true, u(m, y, "in", "out")) : (Object.hasOwnProperty.call(s, y) ? this.raise(w.DuplicateModifier, { at: m, modifier: y }) : (u(m, y, "static", "readonly"), u(m, y, "static", "override"), u(m, y, "override", "readonly"), u(m, y, "abstract", "override"), p(m, y, "declare", "override"), p(m, y, "static", "abstract")), s[y] = true), a != null && a.includes(y) && this.raise(o, { at: m, modifier: y });
      }
    }
    ...
    tsParseDelimitedList(e, s, i) {
      return wl(this.tsParseDelimitedListWorker(e, s, true, i));
    }
    ...
    tsParseNonArrayType() {
      switch (this.state.type) {
        ...
        default: {
          let { type: e } = this.state;
          if (z(e) || e === 88 || e === 84) {
            let s = e === 88 ? "TSVoidKeyword" : e === 84 ? "TSNullKeyword" : Il(this.state.value);
    ...
    tsParseTypeOperatorOrHigher() {
      return To(this.state.type) && !this.state.containsEsc ? this.tsParseTypeOperator() : this.isContextual(113) ? this.tsParseInferType() : this.tsInAllowConditionalTypesContext(() => this.tsParseArrayTypeOrHigher());
    }
    ...
    tsParseInterfaceDeclaration(e) {
      ...
      if (this.hasFollowingLineBreak())
        return null;
      this.expectContextual(127), s.declare && (e.declare = true), z(this.state.type) ? (e.id = this.parseIdentifier(), this.checkIdentifier(e.id, Oo)) : (e.id = null, this.raise(w.MissingInterfaceName, { at: this.state.startLoc })), e.typeParameters = this.tsTryParseTypeParameters(this.tsParseInOutModifiers.bind(this)), this.eat(81) && (e.extends = this.tsParseHeritageClause("extends"));
      let i = this.startNode();
    ...
    tsParseTypeAliasDeclaration(e) {
      return e.id = this.parseIdentifier(), this.checkIdentifier(e.id, Mo), e.typeAnnotation = this.tsInType(() => {
    ...
    tsParseEnumDeclaration(e) {
      let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      return s.const && (e.const = true), s.declare && (e.declare = true), this.expectContextual(124), e.id = this.parseIdentifier(), this.checkIdentifier(e.id, e.const ? _o : Er), this.expect(5), e.members = this.tsParseDelimitedList("EnumMembers", this.tsParseEnumMember.bind(this)), this.expect(8), this.finishNode(e, "TSEnumDeclaration");
    }
    tsParseModuleBlock() {
      let e = this.startNode();
      return this.scope.enter($e), this.expect(5), super.parseBlockOrModuleBlockBody(e.body = [], void 0, true, 8), this.scope.exit(), this.finishNode(e, "TSModuleBlock");
    }
    tsParseModuleOrNamespaceDeclaration(e) {
      let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
      if (e.id = this.parseIdentifier(), s || this.checkIdentifier(e.id, Ro), this.eat(16)) {
        let i = this.startNode();
        this.tsParseModuleOrNamespaceDeclaration(i, true), e.body = i;
      } else
        this.scope.enter(Ve), this.prodParam.enter(Ke), e.body = this.tsParseModuleBlock(), this.prodParam.exit(), this.scope.exit();
    ...
    tsParseImportEqualsDeclaration(e, s) {
      e.isExport = s || false, e.id = this.parseIdentifier(), this.checkIdentifier(e.id, et), this.expect(29);
    ...
    tsParseExpressionStatement(e, s, i) {
      switch (s.name) {
        ...
        case "global":
          if (this.match(5)) {
            this.scope.enter(Ve), this.prodParam.enter(Ke);
            let a = e;
    ...
    parseAssignableListItem(e, s) {
      ...
      let p = this.parseMaybeDefault(u.loc.start, u);
      if (a || n || o) {
      ...
      return s.length && (u.decorators = s), p;
    }
    isSimpleParameter(e) {
    ...
    parseSubscript(e, s, i, a) {
      ...
      if (this.match(47) || this.match(51)) {
        let o, u = this.tsTryParseAndCatch(() => {
          ...
          if (m === 48 || m === 52 || m !== 10 && Vt(m) && !this.hasPrecedingLineBreak())
            return;
    ...
    parseExprOp(e, s, i) {
      let a;
      if (ct(58) > i && !this.hasPrecedingLineBreak() && (this.isContextual(93) || (a = this.isContextual(118)))) {
        let n = this.startNodeAt(s);
    ...
    parseVarStatement(e, s) {
      ...
      for (let { id: o, init: u } of n.declarations)
        !u || (s !== "const" || !!o.typeAnnotation ? this.raise(w.InitializerNotAllowedInAmbientContext, { at: u }) : u.type !== "StringLiteral" && u.type !== "BooleanLiteral" && u.type !== "NumericLiteral" && u.type !== "BigIntLiteral" && (u.type !== "TemplateLiteral" || u.expressions.length > 0) && !Dl(u) && this.raise(w.ConstInitiailizerMustBeStringOrNumericLiteralOrLiteralEnumReference, { at: u }));
      return n;
    }
    ...
    tsHasSomeModifiers(e, s) {
      return s.some((i) => Ur(i) ? e.accessibility === i : !!e[i]);
    }
    ...
    parseClassId(e, s, i, a) {
      if ((!s || i) && this.isContextual(111))
        return;
      super.parseClassId(e, s, i, e.declare ? br : Tr);
    ...
    pushClassMethod(e, s, i, a, n, o) {
      ...
      p && (m === "get" || m === "set") && this.raise(w.DeclareAccessor, { at: s, kind: m }), u && (s.typeParameters = u), super.pushClassMethod(e, s, i, a, n, o);
    }
    pushClassPrivateMethod(e, s, i, a) {
    ...
    parseObjPropValue(e, s, i, a, n, o, u) {
      ...
      return p && (e.typeParameters = p), super.parseObjPropValue(e, s, i, a, n, o, u);
    }
    parseFunctionParams(e, s) {
    ...
    parseMaybeAssign(e, s) {
      ...
      let y, P, b;
      if (this.hasPlugin("jsx") && (this.match(140) || this.match(47))) {
        if (y = this.state.clone(), P = this.tryParse(() => super.parseMaybeAssign(e, s), y), !P.error)
          return P.node;
        let { context: se } = this.state, re = se[se.length - 1];
        (re === U.j_oTag || re === U.j_expr) && se.pop();
      }
      if (!((i = P) != null && i.error) && !this.match(47))
        return super.parseMaybeAssign(e, s);
      (!y || y === this.state) && (y = this.state.clone());
      let B, q = this.tryParse((se) => {
        var re, ee;
        B = this.tsParseTypeParameters();
        let ae = super.parseMaybeAssign(e, s);
        return (ae.type !== "ArrowFunctionExpression" || (re = ae.extra) != null && re.parenthesized) && se(), ((ee = B) == null ? void 0 : ee.params.length) !== 0 && this.resetStartLocationFromNode(ae, B), ae.typeParameters = B, ae;
      }, y);
      if (!q.error && !q.aborted)
        return B && this.reportReservedArrowTypeParam(B), q.node;
      if (!P && (qr(!this.hasPlugin("jsx")), b = this.tryParse(() => super.parseMaybeAssign(e, s), y), !b.error))
        return b.node;
      if ((a = P) != null && a.node)
        return this.state = P.failState, P.node;
      if (q.node)
        return this.state = q.failState, B && this.reportReservedArrowTypeParam(B), q.node;
      if ((n = b) != null && n.node)
        return this.state = b.failState, b.node;
      throw (o = P) != null && o.thrown ? P.error : q.thrown ? q.error : (u = b) != null && u.thrown ? b.error : ((p = P) == null ? void 0 : p.error) || q.error || ((m = b) == null ? void 0 : m.error);
    }
    ...
    isValidLVal(e, s, i) {
      return Sl({ TSTypeCastExpression: true, TSParameterProperty: "parameter", TSNonNullExpression: "expression", TSAsExpression: (i !== Se || !s) && ["expression", true], TSSatisfiesExpression: (i !== Se || !s) && ["expression", true], TSTypeAssertion: (i !== Se || !s) && ["expression", true] }, e) || super.isValidLVal(e, s, i);
    }
    parseBindingAtom() {
      switch (this.state.type) {
        case 78:
    ...
    parseMethod(e, s, i, a, n, o, u) {
      let p = super.parseMethod(e, s, i, a, n, o, u);
      if (p.abstract && (this.hasPlugin("estree") ? !!p.value.body : !!p.body)) {
        let { key: y } = p;
        this.raise(w.AbstractMethodHasImplementation, { at: p, methodName: y.type === "Identifier" && !p.computed ? y.name : `[${this.input.slice(y.start, y.end)}]` });
      }
      return p;
    }
    ...
    parseImportSpecifier(e, s, i, a, n) {
      return !s && a ? (this.parseTypeOnlyImportExportSpecifier(e, true, i), this.finishNode(e, "ImportSpecifier")) : (e.importKind = "value", super.parseImportSpecifier(e, s, i, a, i ? Cr : et));
    }
    parseTypeOnlyImportExportSpecifier(e, s, i) {
      let a = s ? "imported" : "local", n = s ? "local" : "exported", o = e[a], u, p = false, m = true, y = o.loc.start;
      if (this.isContextual(93)) {
        let b = this.parseIdentifier();
        if (this.isContextual(93)) {
          let B = this.parseIdentifier();
          ye(this.state.type) ? (p = true, o = b, u = s ? this.parseIdentifier() : this.parseModuleExportName(), m = false) : (u = B, m = false);
        } else
          ye(this.state.type) ? (m = false, u = s ? this.parseIdentifier() : this.parseModuleExportName()) : (p = true, o = b);
      } else
      ...
      p && i && this.raise(s ? w.TypeModifierIsUsedInTypeImports : w.TypeModifierIsUsedInTypeExports, { at: y }), e[a] = o, e[n] = u;
      let P = s ? "importKind" : "exportKind";
      e[P] = p ? "type" : "value", m && this.eatContextual(93) && (e[n] = s ? this.parseIdentifier() : this.parseModuleExportName()), e[n] || (e[n] = Te(e[a])), s && this.checkIdentifier(e[n], p ? Cr : et);
    }
  };
  function Dl(t) {
    ...
    return r && e.type !== "StringLiteral" && (e.type !== "TemplateLiteral" || e.expressions.length > 0) ? false : Hr(t.object);
  }
  function Hr(t) {
    return t.type === "Identifier" ? true : t.type !== "MemberExpression" || t.computed ? false : Hr(t.object);
  }
  var $r = _`placeholders`({ ClassNameIsRequired: "A class name is required.", UnexpectedSpace: "Unexpected space in placeholder." }), Fl = (t) => class extends t {
    parsePlaceholder(e) {
      if (this.match(142)) {
        let s = this.startNode();
    ...
    parseClass(e, s, i) {
      ...
      if (o)
        if (this.match(81) || this.match(142) || this.match(5))
          ...
          throw this.raise($r.ClassNameIsRequired, { at: this.state.startLoc });
        }
      else
    ...
    isExportDefaultSpecifier() {
      if (this.match(65)) {
        let e = this.nextTokenStart();
        if (this.isUnparsedContextual(e, "from") && this.input.startsWith(be(142), this.nextTokenStartSince(e + 4)))
          return true;
      }
    ...
    assertNoSpace() {
      this.state.start > this.state.lastTokEndLoc.index && this.raise($r.UnexpectedSpace, { at: this.state.lastTokEndLoc });
    }
  }, Ll = (t) => class extends t {
    parseV8Intrinsic() {
      if (this.match(54)) {
  ...
  var zr = ["minimal", "fsharp", "hack", "smart"], Vr = ["^^", "@@", "^", "%", "#"], Kr = ["hash", "bar"];
  function Ol(t) {
    if (ie(t, "decorators")) {
      if (ie(t, "decorators-legacy"))
        throw new Error("Cannot use the decorators and decorators-legacy plugin together");
      let r = Be(t, "decorators", "decoratorsBeforeExport");
      if (r != null && typeof r != "boolean")
        throw new Error("'decoratorsBeforeExport' must be a boolean.");
      let e = Be(t, "decorators", "allowCallParenthesized");
      if (e != null && typeof e != "boolean")
        throw new Error("'allowCallParenthesized' must be a boolean.");
    }
    if (ie(t, "flow") && ie(t, "typescript"))
      throw new Error("Cannot combine flow and typescript plugins.");
    if (ie(t, "placeholders") && ie(t, "v8intrinsic"))
      throw new Error("Cannot combine placeholders and v8intrinsic plugins.");
    if (ie(t, "pipelineOperator")) {
      let r = Be(t, "pipelineOperator", "proposal");
      if (!zr.includes(r)) {
        let s = zr.map((i) => `"${i}"`).join(", ");
        throw new Error(`"pipelineOperator" requires "proposal" option whose value must be one of: ${s}.`);
      }
      let e = ie(t, ["recordAndTuple", { syntaxType: "hash" }]);
      if (r === "hack") {
        if (ie(t, "placeholders"))
          throw new Error("Cannot combine placeholders plugin and Hack-style pipes.");
        if (ie(t, "v8intrinsic"))
          throw new Error("Cannot combine v8intrinsic plugin and Hack-style pipes.");
        let s = Be(t, "pipelineOperator", "topicToken");
        if (!Vr.includes(s)) {
          let i = Vr.map((a) => `"${a}"`).join(", ");
    ...
    if (ie(t, "moduleAttributes")) {
      if (ie(t, "importAssertions"))
        throw new Error("Cannot combine importAssertions and moduleAttributes plugins.");
      if (Be(t, "moduleAttributes", "version") !== "may-2020")
        throw new Error("The 'moduleAttributes' plugin requires a 'version' option, representing the last proposal update. Currently, the only supported value is 'may-2020'.");
    }
    if (ie(t, "recordAndTuple") && Be(t, "recordAndTuple", "syntaxType") != null && !Kr.includes(Be(t, "recordAndTuple", "syntaxType")))
      throw new Error("The 'syntaxType' option of the 'recordAndTuple' plugin must be one of: " + Kr.map((r) => `'${r}'`).join(", "));
    if (ie(t, "asyncDoExpressions") && !ie(t, "doExpressions")) {
  ...
  var _l = (t, r) => Object.hasOwnProperty.call(t, r) && t[r], Jr = (t) => t.type === "ParenthesizedExpression" ? Jr(t.expression) : t, Rl = class extends ml {
    ...
    isValidLVal(t, r, e) {
      return _l({ AssignmentPattern: "left", RestElement: "argument", ObjectProperty: "value", ParenthesizedExpression: "expression", ArrayPattern: "elements", ObjectPattern: "properties" }, t);
    }
    checkLVal(t, r) {
      let { in: e, binding: s = Se, checkClashes: i = false, strictModeChanged: a = false, allowingSloppyLetBinding: n = !(s & Ce), hasParenthesizedAncestor: o = false } = r;
      var u;
      let p = t.type;
      if (this.isObjectMethod(t))
        return;
      if (p === "MemberExpression") {
        s !== Se && this.raise(h.InvalidPropertyBindingPattern, { at: t });
        return;
      }
      if (t.type === "Identifier") {
        this.checkIdentifier(t, s, a, n);
        let { name: B } = t;
        i && (i.has(B) ? this.raise(h.ParamDupe, { at: t }) : i.add(B));
        return;
      }
      let m = this.isValidLVal(t.type, !(o || (u = t.extra) != null && u.parenthesized) && e.type === "AssignmentExpression", s);
      if (m === true)
        return;
      if (m === false) {
        let B = s === Se ? h.InvalidLhs : h.InvalidLhsBinding;
        this.raise(B, { at: t, ancestor: e.type === "UpdateExpression" ? { type: "UpdateExpression", prefix: e.prefix } : { type: e.type } });
        return;
      }
      let [y, P] = Array.isArray(m) ? m : [m, p === "ParenthesizedExpression"], b = t.type === "ArrayPattern" || t.type === "ObjectPattern" || t.type === "ParenthesizedExpression" ? t : e;
      for (let B of [].concat(t[y]))
        B && this.checkLVal(B, { in: b, binding: s, checkClashes: i, allowingSloppyLetBinding: n, strictModeChanged: a, hasParenthesizedAncestor: P });
    }
    checkIdentifier(t, r) {
      let e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, s = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !(r & Ce);
      this.state.strict && (e ? yr(t.name, this.inModule) : mr(t.name)) && (r === Se ? this.raise(h.StrictEvalArguments, { at: t, referenceName: t.name }) : this.raise(h.StrictEvalArgumentsBinding, { at: t, bindingName: t.name })), !s && t.name === "let" && this.raise(h.LetInLexicalBinding, { at: t }), r & Se || this.declareNameFromIdentifier(t, r);
    }
    ...
    parseMaybeAssign(t, r) {
      ...
      if (r && (a = r.call(this, a, e)), yo(this.state.type)) {
    ...
    parseExprOp(t, r, e) {
      if (this.isPrivateName(t)) {
        ...
        (e >= ct(58) || !this.prodParam.hasIn || !this.match(58)) && this.raise(h.PrivateInExpectedIn, { at: t, identifierName: i }), this.classScope.usePrivateName(i, t.loc.start);
      }
      let s = this.state.type;
      if (go(s) && (this.prodParam.hasIn || !this.match(58))) {
        let i = ct(s);
        if (i > e) {
          if (s === 39) {
          ...
          if (o && (i = ct(42)), this.next(), s === 39 && this.hasPlugin(["pipelineOperator", { proposal: "minimal" }]) && this.state.type === 96 && this.prodParam.hasAwait)
            throw this.raise(h.UnexpectedAwaitAfterPipelineBody, { at: this.state.startLoc });
          a.right = this.parseExprOpRightExpr(s, i);
          let u = this.finishNode(a, n || o ? "LogicalExpression" : "BinaryExpression"), p = this.state.type;
    ...
    parseExprOpBaseRightExpr(t, r) {
      let e = this.state.startLoc;
      return this.parseExprOp(this.parseMaybeUnaryOrPrivate(), e, Eo(t) ? r - 1 : r);
    }
    parseHackPipeBody() {
      var t;
      let { startLoc: r } = this.state, e = this.parseMaybeAssign();
      return R.has(e.type) && !((t = e.extra) != null && t.parenthesized) && this.raise(h.PipeUnparenthesizedBody, { at: r, type: e.type }), this.topicReferenceWasUsedInCurrentContext() || this.raise(h.PipeTopicUnused, { at: r }), e;
    }
    ...
    parseMaybeUnary(t, r) {
      ...
      if (Ao(this.state.type)) {
        ...
        if (this.next(), a.argument = this.parseMaybeUnary(null, true), this.checkExpressionErrors(t, true), this.state.strict && o) {
          let u = a.argument;
          u.type === "Identifier" ? this.raise(h.StrictDelete, { at: a }) : this.hasPropertyAsPrivateName(u) && this.raise(h.DeletePrivateField, { at: a });
        }
        if (!i)
      ...
      if (s) {
        ...
        if ((this.hasPlugin("v8intrinsic") ? Vt(o) : Vt(o) && !this.match(54)) && !this.isAmbiguousAwait())
    ...
    parseUpdate(t, r, e) {
      ...
      if (this.checkExpressionErrors(e, false))
        return i;
      for (; Po(this.state.type) && !this.canInsertSemicolon(); ) {
        let a = this.startNodeAt(s);
    ...
    parseCoverCallAndAsyncArrowHead(t, r, e, s) {
      ...
      o && (this.expressionScope.enter(ul()), a = new Ct()), u && (n.optional = s), s ? n.arguments = this.parseCallExpressionArguments(11) : n.arguments = this.parseCallExpressionArguments(11, t.type === "Import", t.type !== "Super", n, a);
      let p = this.finishCallExpression(n, u);
    ...
    parseAsyncArrowFromCallExpression(t, r) {
      var e;
      return this.resetPreviousNodeTrailingComments(r), this.expect(19), this.parseArrowExpression(t, r.arguments, true, (e = r.extra) == null ? void 0 : e.trailingCommaLoc), r.innerComments && tt(t, r.innerComments), r.callee.trailingComments && tt(t, r.callee.trailingComments), t;
    }
    parseNoCallExpr() {
    ...
    parseTopicReferenceThenEqualsSign(t, r) {
      ...
      if (e)
        return this.state.type = t, this.state.value = r, this.state.pos--, this.state.end--, this.state.endLoc = x(this.state.endLoc, -1), this.parseTopicReference(e);
      throw this.unexpected();
    }
    ...
    finishTopicReference(t, r, e, s) {
      if (this.testTopicReferenceConfiguration(e, r, s)) {
        ...
        throw this.raise(h.PipeTopicUnconfiguredToken, { at: r, token: be(s) });
    }
    testTopicReferenceConfiguration(t, r, e) {
      switch (t) {
        case "hack":
          return this.hasPlugin(["pipelineOperator", { topicToken: be(e) }]);
        case "smart":
          return e === 27;
        default:
    ...
    parseAsyncArrowUnaryFunction(t) {
      this.prodParam.enter(bt(true, this.prodParam.hasYield));
    ...
    parseDo(t, r) {
      ...
      return this.state.labels = [], r ? (this.prodParam.enter(Et), t.body = this.parseBlock(), this.prodParam.exit()) : t.body = this.parseBlock(), this.state.labels = e, this.finishNode(t, "DoExpression");
    }
    parseSuper() {
      let t = this.startNode();
    ...
    parsePrivateName() {
      let t = this.startNode(), r = this.startNodeAt(x(this.state.startLoc, 1)), e = this.state.value;
    ...
    parseTemplateElement(t) {
      let { start: r, startLoc: e, end: s, value: i } = this.state, a = r + 1, n = this.startNodeAt(x(e, 1));
      i === null && (t || this.raise(h.InvalidEscapeSequenceTemplate, { at: x(this.state.firstInvalidTemplateEscapePos, 1) }));
      let o = this.match(24), u = o ? -1 : -2, p = s + u;
...
`), cooked: i === null ? null : i.slice(1, u) }, n.tail = o, this.next();
      ...
      return this.resetEndLocation(m, x(this.state.lastTokEndLoc, u)), m;
    }
    parseTemplate(t) {
      let r = this.startNode();
      r.expressions = [];
    ...
    parsePropertyDefinition(t) {
      ...
      if (!n && !o && this.maybeAsyncOrAccessorProp(e)) {
        let p = u.name;
        p === "async" && !this.hasPrecedingLineBreak() && (s = true, this.resetPreviousNodeTrailingComments(u), n = this.eat(55), this.parsePropertyName(e)), (p === "get" || p === "set") && (i = true, this.resetPreviousNodeTrailingComments(u), e.kind = p, this.match(55) && (n = true, this.raise(h.AccessorIsGenerator, { at: this.state.curPosition(), kind: p }), this.next()), this.parsePropertyName(e));
      }
    ...
    parseObjectProperty(t, r, e, s) {
      ...
      if (!t.computed && t.key.type === "Identifier") {
        if (this.checkReservedWord(t.key.name, t.key.loc.start, true, false), e)
          ...
          s != null ? s.shorthandAssignLoc === null && (s.shorthandAssignLoc = i) : this.raise(h.InvalidCoverInitializedName, { at: i }), t.value = this.parseMaybeDefault(r, Te(t.key));
        } else
          t.value = Te(t.key);
    ...
    parseMethod(t, r, e, s, i, a) {
      ...
      let o = s;
      this.scope.enter(Pe | ft | (n ? Fe : 0) | (i ? gr : 0)), this.prodParam.enter(bt(e, t.generator)), this.parseFunctionParams(t, o);
      let u = this.parseFunctionBodyAndFinish(t, a, true);
    ...
    parseArrowExpression(t, r, e, s) {
      this.scope.enter(Pe | Xt);
      let i = bt(e, false);
      !this.match(5) && this.prodParam.hasIn && (i |= We), this.prodParam.enter(i), this.initFunction(t, e);
    ...
    parseFunctionBody(t, r) {
      ...
      if (this.expressionScope.enter(Br()), s)
        t.body = this.parseMaybeAssign(), this.checkParams(t, false, r, false);
      else {
        let i = this.state.strict, a = this.state.labels;
        this.state.labels = [], this.prodParam.enter(this.prodParam.currentFlags() | Rr), t.body = this.parseBlock(true, false, (n) => {
          ...
          this.checkParams(t, !this.state.strict && !r && !e && !o, r, u), this.state.strict && t.id && this.checkIdentifier(t.id, Bo, u);
    ...
    checkParams(t, r, e) {
      ...
      for (let n of t.params)
        this.checkLVal(n, { in: a, binding: gt, checkClashes: i, strictModeChanged: s });
    }
    ...
    checkReservedWord(t, r, e, s) {
      ...
      (this.state.strict ? s ? yr : dr : fr)(t, this.inModule) && this.raise(h.UnexpectedReservedWord, { at: r, reservedWord: t });
    }
    isAwaitAllowed() {
    ...
    isAmbiguousAwait() {
      if (this.hasPrecedingLineBreak())
        return true;
      let { type: t } = this.state;
      return t === 53 || t === 10 || t === 0 || pt(t) || t === 135 || t === 56 || this.hasPlugin("v8intrinsic") && t === 54;
    }
    parseYield() {
      let t = this.startNode();
  ...
  }, fs = { kind: "loop" }, ql = { kind: "switch" }, Ul = 0, ds = 1, Xr = 2, Yr = 4, Hl = /[\uD800-\uDFFF]/u, ms = /in(?:stanceof)?/y;
  function $l(t, r) {
    for (let e = 0; e < t.length; e++) {
      ...
      if (typeof i == "number") {
        {
          if (i === 136) {
            let { loc: a, start: n, value: o, end: u } = s, p = n + 1, m = x(a.start, 1);
            t.splice(e, 1, new we({ type: xe(27), value: "#", start: n, end: p, startLoc: a.start, endLoc: m }), new we({ type: xe(130), value: o, start: p, end: u, startLoc: m, endLoc: a.end })), e++;
            continue;
          }
          if (pt(i)) {
            let { loc: a, start: n, value: o, end: u } = s, p = n + 1, m = x(a.start, 1), y;
            r.charCodeAt(n) === 96 ? y = new we({ type: xe(22), value: "`", start: n, end: p, startLoc: a.start, endLoc: m }) : y = new we({ type: xe(8), value: "}", start: n, end: p, startLoc: a.start, endLoc: m });
            let P, b, B, q;
            i === 24 ? (b = u - 1, B = x(a.end, -1), P = o === null ? null : o.slice(1, -1), q = new we({ type: xe(22), value: "`", start: b, end: u, startLoc: B, endLoc: a.end })) : (b = u - 2, B = x(a.end, -2), P = o === null ? null : o.slice(1, -2), q = new we({ type: xe(23), value: "${", start: b, end: u, startLoc: B, endLoc: a.end })), t.splice(e, 1, y, new we({ type: xe(20), value: P, start: p, end: b, startLoc: m, endLoc: B }), q), e += 2;
            continue;
          }
        }
        s.type = xe(i);
  ...
  var zl = class extends jl {
    parseTopLevel(t, r) {
      return t.program = this.parseProgram(r), t.comments = this.state.comments, this.options.tokens && (t.tokens = $l(this.tokens, this.input)), this.finishNode(t, "File");
    }
    parseProgram(t) {
      ...
      let s;
      return r === 137 ? s = this.finishNode(t, "Program") : s = this.finishNodeAt(t, "Program", x(this.state.startLoc, -1)), s;
    }
    stmtToDirective(t) {
      let r = t;
    ...
    hasFollowingIdentifier(t) {
      ...
      if (e === 123)
        return true;
      if (ge(e)) {
        if (ms.lastIndex = r, ms.test(this.input)) {
          let s = this.codePointAtPos(ms.lastIndex);
          if (!He(s) && s !== 92)
            return false;
        }
        return true;
    ...
    parseForStatement(t) {
      ...
      let r = null;
      if (this.isAwaitAllowed() && this.eatContextual(96) && (r = this.state.lastTokStartLoc), this.scope.enter($e), this.expect(10), this.match(13))
      ...
      if (this.match(74) || this.match(75) || i) {
        ...
        let y = this.finishNode(p, "VariableDeclaration"), P = this.match(58);
        return P && s && this.raise(h.ForInUsing, { at: y }), (P || this.isContextual(101)) && y.declarations.length === 1 ? this.parseForIn(t, y, r) : (r !== null && this.unexpected(r), this.parseFor(t, y));
      }
      let a = this.isContextual(95), n = new Ct(), o = this.parseExpression(true, n), u = this.isContextual(101);
      if (u && (e && this.raise(h.ForOfLet, { at: o }), r === null && a && o.type === "Identifier" && this.raise(h.ForOfAsync, { at: o })), u || this.match(58)) {
        this.checkDestructuringPrivate(n), this.toAssignable(o, true);
        let p = u ? "ForOfStatement" : "ForInStatement";
    ...
    parseFunctionStatement(t, r, e) {
      return this.next(), this.parseFunction(t, ds | (e ? 0 : Xr), r);
    }
    parseIfStatement(t) {
    ...
    parseSwitchStatement(t) {
      ...
      let r = t.cases = [];
      this.expect(5), this.state.labels.push(ql), this.scope.enter($e);
      let e;
    ...
    parseCatchClauseParam() {
      ...
      return this.scope.enter(r ? xr : 0), this.checkLVal(t, { in: { type: "CatchClause" }, binding: Oe, allowingSloppyLetBinding: true }), t;
    }
    parseTryStatement(t) {
      if (this.next(), t.block = this.parseBlock(), t.handler = null, this.match(62)) {
        let r = this.startNode();
        this.next(), this.match(10) ? (this.expect(10), r.param = this.parseCatchClauseParam(), this.expect(11)) : (r.param = null, this.scope.enter($e)), r.body = this.withSmartMixTopicForbiddingContext(() => this.parseBlock(false, false)), this.scope.exit(), t.handler = this.finishNode(r, "CatchClause");
      }
    ...
    parseLabeledStatement(t, r, e, s) {
      ...
      let i = xo(this.state.type) ? "loop" : this.match(71) ? "switch" : null;
    ...
    parseBlock() {
      ...
      return t && this.state.strictErrors.clear(), this.expect(5), r && this.scope.enter($e), this.parseBlockBody(s, t, false, 8, e), r && this.scope.exit(), this.finishNode(s, "BlockStatement");
    }
    isValidDirective(t) {
    ...
    parseBlockOrModuleBlockBody(t, r, e, s, i) {
      ...
      for (; !this.match(s); ) {
        let u = this.parseStatement(null, e);
        if (r && !o) {
          if (this.isValidDirective(u)) {
            let p = this.stmtToDirective(u);
    ...
    parseVarId(t, r) {
      ...
      r === "using" && e.type !== "Identifier" && this.raise(h.UsingDeclarationHasBindingPattern, { at: e }), this.checkLVal(e, { in: { type: "VariableDeclarator" }, binding: r === "var" ? gt : Oe }), t.id = e;
    }
    parseFunction(t) {
      let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Ul, e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, s = r & ds, i = r & Xr, a = !!s && !(r & Yr);
      ...
      return this.state.maybeInArrowParameters = false, this.scope.enter(Pe), this.prodParam.enter(bt(e, t.generator)), s || (t.id = this.parseFunctionId()), this.parseFunctionParams(t, false), this.withSmartMixTopicForbiddingContext(() => {
    ...
    parseFunctionParams(t, r) {
      this.expect(10), this.expressionScope.enter(ll()), t.params = this.parseBindingList(11, 41, false, r), this.expressionScope.exit();
    }
    registerFunctionStatementId(t) {
      !t.id || this.scope.declareName(t.id.name, this.state.strict || t.generator || t.async ? this.scope.treatFunctionsAsVar ? gt : Oe : vr, t.id.loc.start);
    }
    parseClass(t, r, e) {
      this.next();
    ...
    parseClassMemberWithIsStatic(t, r, e, s) {
      let i = r, a = r, n = r, o = r, u = r, p = i, m = i;
      ...
      let y = z(this.state.type) && !this.state.containsEsc, P = this.match(136), b = this.parseClassElementName(r), B = this.state.startLoc;
      if (this.parsePostMemberNameModifiers(m), this.isClassMethod()) {
        if (p.kind = "method", P) {
          this.pushClassPrivateMethod(t, a, false, false);
          return;
        }
        let q = this.isNonstaticConstructor(i), se = false;
        q && (i.kind = "constructor", e.hadConstructor && !this.hasPlugin("typescript") && this.raise(h.DuplicateConstructor, { at: b }), q && this.hasPlugin("typescript") && r.override && this.raise(h.OverrideOnConstructor, { at: b }), e.hadConstructor = true, se = e.hadSuperClass), this.pushClassMethod(t, i, false, false, q, se);
      } else if (this.isClassProperty())
        P ? this.pushClassPrivateProperty(t, o) : this.pushClassProperty(t, n);
      else if (y && b.name === "async" && !this.isLineTerminator()) {
        this.resetPreviousNodeTrailingComments(b);
        let q = this.eat(55);
        m.optional && this.unexpected(B), p.kind = "method";
        let se = this.match(136);
        this.parseClassElementName(p), this.parsePostMemberNameModifiers(m), se ? this.pushClassPrivateMethod(t, a, q, true) : (this.isNonstaticConstructor(i) && this.raise(h.ConstructorIsAsync, { at: i.key }), this.pushClassMethod(t, i, q, true, false, false));
      } else if (y && (b.name === "get" || b.name === "set") && !(this.match(55) && this.isLineTerminator())) {
        this.resetPreviousNodeTrailingComments(b), p.kind = b.name;
        let q = this.match(136);
        this.parseClassElementName(i), q ? this.pushClassPrivateMethod(t, a, false, false) : (this.isNonstaticConstructor(i) && this.raise(h.ConstructorIsAccessor, { at: i.key }), this.pushClassMethod(t, i, false, false, false, false)), this.checkGetterSetterParams(i);
      } else if (y && b.name === "accessor" && !this.isLineTerminator()) {
    ...
    pushClassPrivateProperty(t, r) {
      ...
      t.body.push(e), this.classScope.declarePrivateName(this.getPrivateNameSV(e.key), is, e.key.loc.start);
    }
    pushClassAccessorProperty(t, r, e) {
      ...
      t.body.push(s), e && this.classScope.declarePrivateName(this.getPrivateNameSV(s.key), is, s.key.loc.start);
    }
    ...
    pushClassPrivateMethod(t, r, e, s) {
      ...
      t.body.push(i);
      let a = i.kind === "get" ? i.static ? qo : Ho : i.kind === "set" ? i.static ? Uo : $o : is;
    ...
    parseInitializer(t) {
      this.scope.enter(Fe | ft), this.expressionScope.enter(Br()), this.prodParam.enter(Ke), t.value = this.eat(29) ? this.parseMaybeAssignAllowIn() : null, this.expressionScope.exit(), this.prodParam.exit(), this.scope.exit();
    }
    parseClassId(t, r, e) {
      let s = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : Tr;
      if (z(this.state.type))
    ...
    parseExport(t, r) {
      ...
      if (o || u || p) {
        var m;
        let y = t;
        if (this.checkExport(y, true, false, !!y.source), ((m = y.declaration) == null ? void 0 : m.type) === "ClassDeclaration")
      ...
      if (this.eat(65)) {
        let y = t, P = this.parseExportDefaultExpression();
        if (y.declaration = P, P.type === "ClassDeclaration")
          this.maybeTakeDecorators(r, P, y);
        else if (r)
          throw this.raise(h.UnsupportedDecoratorExport, { at: t });
        return this.checkExport(y, true, true), this.finishNode(y, "ExportDefaultDeclaration");
      }
      throw this.unexpected(null, 5);
    }
    eatExportStar(t) {
    ...
    isAsyncFunction() {
      ...
      return !os.test(this.input.slice(this.state.pos, t)) && this.isUnparsedContextual(t, "function");
    }
    parseExportDefaultExpression() {
      let t = this.startNode(), r = this.isAsyncFunction();
      if (this.match(68) || r)
        return this.next(), r && this.next(), this.parseFunction(t, ds | Yr, r);
      if (this.match(80))
        ...
        if (e) {
          ...
          for (let a of t.specifiers) {
            ...
            if (this.checkDuplicateExports(a, o), !s && a.local) {
              let { local: u } = a;
              u.type !== "Identifier" ? this.raise(h.ExportBindingIsString, { at: a, localName: u.value, exportName: o }) : (this.checkReservedWord(u.name, u.loc.start, true, false), this.scope.checkLocalExport(u));
            }
          }
    ...
    parseExportSpecifier(t, r, e, s) {
      return this.eatContextual(93) ? t.exported = this.parseModuleExportName() : r ? t.exported = dl(t.local) : t.exported || (t.exported = Te(t.local)), this.finishNode(t, "ExportSpecifier");
    }
    parseModuleExportName() {
      if (this.match(131)) {
        let t = this.parseStringLiteral(this.state.value), r = t.value.match(Hl);
    ...
    finishImportSpecifier(t, r) {
      let e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : Oe;
    ...
    constructor(t, r) {
      t = Bl(t), super(t, r), this.options = t, this.initializeScopes(), this.plugins = Vl(this.options.plugins), this.filename = t.sourceFilename;
    }
    getScopeHandler() {
      return ns;
    }
  ...
  function Kl(t, r) {
    ...
    if (((e = r) == null ? void 0 : e.sourceType) === "unambiguous") {
      ...
      try {
        r.sourceType = "module";
        let s = at(r, t), i = s.parse();
        if (s.sawUnambiguousESM)
          return i;
        if (s.ambiguousScriptDifferentAst)
          try {
            return r.sourceType = "script", at(r, t).parse();
          } catch {
          }
        else
  ...
  function at(t, r) {
    let e = Qr;
    return t != null && t.plugins && (Ol(t.plugins), e = Xl(t.plugins)), new e(t, r);
  }
  var Zr = {};
  function Xl(t) {
    let r = Ml.filter((i) => ie(t, i)), e = r.join("/"), s = Zr[e];
    if (!s) {
      s = Qr;
      for (let i of r)
        s = Wr[i](s);
  ...
  l.parse = Kl, l.parseExpression = Wl, l.tokTypes = Jl;
} });
var uf = W({ "src/language-js/parse/json.js"(l, c) {
  "use strict";
  K();
  var f = or(), d = lr(), x = oo(), g = lo();
  function A() {
    let C = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, { allowComments: L = true } = C;
    return function(N) {
      let { parseExpression: $ } = co(), X;
      try {
        X = $(N, { tokens: true, ranges: true });
      } catch (D) {
        throw g(D);
      }
      if (!L && f(X.comments))
        throw T(X.comments[0], "Comment");
      return S(X), X;
    };
  }
  function T(C, L) {
    let [R, N] = [C.loc.start, C.loc.end].map(($) => {
      let { line: X, column: D } = $;
      return { line: X, column: D + 1 };
    });
    return d(`${L} is not allowed in JSON.`, { start: R, end: N });
  }
  function S(C) {
    switch (C.type) {
      case "ArrayExpression":
  ...
  var O = A(), I = { json: x({ parse: O, hasPragma() {
    return true;
  } }), json5: x(O), "json-stringify": x({ parse: A({ allowComments: false }), astFormat: "estree-json" }) };
  c.exports = I;
} });
var cf = W({ "src/language-js/parse/babel.js"(l, c) {
  K();
  var f = zp(), d = Vn(), x = Gp(), g = oo(), A = lo(), T = hf(), S = uf(), O = { sourceType: "module", allowImportExportEverywhere: true, allowReturnOutsideFunction: true, allowSuperOutsideMethod: true, allowUndeclaredExports: true, errorRecovery: true, createParenthesizedExpressions: true, plugins: ["doExpressions", "exportDefaultFrom", "functionBind", "functionSent", "throwExpressions", "partialApplication", ["decorators", { decoratorsBeforeExport: false }], "importAssertions", "decimal", "moduleBlocks", "asyncDoExpressions", "regexpUnicodeSets", "destructuringPrivate", "decoratorAutoAccessors"], tokens: true, ranges: true }, I = ["recordAndTuple", { syntaxType: "hash" }], C = "v8intrinsic", L = [["pipelineOperator", { proposal: "hack", topicToken: "%" }], ["pipelineOperator", { proposal: "minimal" }], ["pipelineOperator", { proposal: "fsharp" }]], R = function(V) {
    let Q = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : O;
    return Object.assign(Object.assign({}, Q), {}, { plugins: [...Q.plugins, ...V] });
  }, N = /@(?:no)?flow\b/;
  function $(V, Q) {
    if (Q.filepath && Q.filepath.endsWith(".js.flow"))
      return true;
    let me = d(V);
    me && (V = V.slice(me.length));
    let fe = x(V, 0);
    return fe !== false && (V = V.slice(0, fe)), N.test(V);
  }
  function X(V, Q, me) {
    let le = co()[V](Q, me), j = le.errors.find((G) => !te.has(G.reasonCode));
    if (j)
      throw j;
    return le;
  }
  function D(V) {
    for (var Q = arguments.length, me = new Array(Q > 1 ? Q - 1 : 0), fe = 1; fe < Q; fe++)
      me[fe - 1] = arguments[fe];
    return function(le, j) {
      let G = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      if ((G.parser === "babel" || G.parser === "__babel_estree") && $(le, G))
        return G.parser = "babel-flow", h(le, j, G);
      let ne = me;
      G.__babelSourceType === "script" && (ne = ne.map((ue) => Object.assign(Object.assign({}, ue), {}, { sourceType: "script" }))), /#[[{]/.test(le) && (ne = ne.map((ue) => R([I], ue)));
      let he = /%[A-Z]/.test(le);
      le.includes("|>") ? ne = (he ? [...L, C] : L).flatMap((Qe) => ne.map((Ze) => R([Qe], Ze))) : he && (ne = ne.map((ue) => R([C], ue)));
      let { result: Ue, error: Ye } = f(...ne.map((ue) => () => X(V, le, ue)));
      if (!Ue)
        throw A(Ye);
      return G.originalText = le, T(Ue, G);
    };
  }
  var _ = D("parse", R(["jsx", "flow"])), h = D("parse", R(["jsx", ["flow", { all: true, enums: true }]])), Y = D("parse", R(["jsx", "typescript"]), R(["typescript"])), oe = D("parse", R(["jsx", "flow", "estree"])), Z = D("parseExpression", R(["jsx"])), Ee = D("parseExpression", R(["typescript"])), te = /* @__PURE__ */ new Set(["StrictNumericEscape", "StrictWith", "StrictOctalLiteral", "StrictDelete", "StrictEvalArguments", "StrictEvalArgumentsBinding", "StrictFunction", "EmptyTypeArguments", "EmptyTypeParameters", "ConstructorHasTypeParameters", "UnsupportedParameterPropertyKind", "UnexpectedParameterModifier", "MixedLabeledAndUnlabeledElements", "InvalidTupleMemberLabel", "NonClassMethodPropertyHasAbstractModifer", "ReadonlyForMethodSignature", "ClassMethodHasDeclare", "ClassMethodHasReadonly", "InvalidModifierOnTypeMember", "DuplicateAccessibilityModifier", "IndexSignatureHasDeclare", "DecoratorExportClass", "ParamDupe", "InvalidDecimal", "RestTrailingComma", "UnsupportedParameterDecorator", "UnterminatedJsxContent", "UnexpectedReservedWord", "ModuleAttributesWithDuplicateKeys", "LineTerminatorBeforeArrow", "InvalidEscapeSequenceTemplate", "NonAbstractClassHasAbstractMethod", "UnsupportedPropertyDecorator", "OptionalTypeBeforeRequired", "PatternIsOptional", "OptionalBindingPattern", "DeclareClassFieldHasInitializer", "TypeImportCannotSpecifyDefaultAndNamed", "DeclareFunctionHasImplementation", "ConstructorClassField", "VarRedeclaration", "InvalidPrivateFieldResolution", "DuplicateExport"]), U = g(_), M = g(Y), v = g(Z), De = g(Ee);
  c.exports = { parsers: Object.assign(Object.assign({ babel: U, "babel-flow": g(h), "babel-ts": M }, S), {}, { __js_expression: v, __vue_expression: v, __vue_ts_expression: De, __vue_event_binding: U, __vue_ts_event_binding: M, __babel_estree: g(oe) }) };
} });
var jd = cf();
export {
  jd as default
