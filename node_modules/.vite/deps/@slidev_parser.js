import {
  js_yaml_default
} from "./chunk-VV2EAJ2M.js";
import {
  __publicField
} from "./chunk-6SKLCPBR.js";

// node_modules/@slidev/parser/dist/chunk-RQLJEQ6S.mjs
...
async function parse(markdown, filepath, themeMeta, extensions, onHeadmatter) {
  ...
  }
  {
    ...
    if (onHeadmatter) {
      const o = (_b = js_yaml_default.load(hm)) != null ? _b : {};
      extensions = await onHeadmatter(o, extensions != null ? extensions : [], filepath);
    }
  }
  if (extensions) {
    for (const e of extensions) {
  ...
  const headmatter = ((_c = slides[0]) == null ? void 0 : _c.frontmatter) || {};
  headmatter.title = headmatter.title || ((_d = slides[0]) == null ? void 0 : _d.title);
